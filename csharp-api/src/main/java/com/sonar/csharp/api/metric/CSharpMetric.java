...
public enum CSharpMetric implements MetricDef {
  FILES, NAMESPACES, CLASSES, METHODS, LINES, LINES_OF_CODE, STATEMENTS, ACCESSORS, COMPLEXITY,
  PUBLIC_API, PUBLIC_DOC_API,  COMMENT_BLANK_LINES, COMMENTED_OUT_CODE_LINES, COMMENT_LINES;
