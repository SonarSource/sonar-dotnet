...
public enum CSharpMetric implements MetricDef {
  FILES, NAMESPACES, CLASSES, METHODS, LINES, LINES_OF_CODE, STATEMENTS, ACCESSORS, COMPLEXITY, COMMENT_BLANK_LINES, COMMENTED_OUT_CODE_LINES, COMMENT_LINES, PUBLIC_API, PUBLIC_UNDOC_API;
