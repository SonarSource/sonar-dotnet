...
namespace NSonarQubeAnalyzer
{
    public class Configuration
    {
        ...
        public ImmutableArray<DiagnosticAnalyzer> Analyzers(Solution currentSolution)
        {
            ...
            AddAnalyzerUnusedLocalVariable(currentSolution, builder);
        ...
        private static void AddAnalyzerUnusedLocalVariable(Solution currentSolution, ImmutableArray<DiagnosticAnalyzer>.Builder builder)
        {
