namespace Nancy.ViewEngines.Razor
{
    ...
    public class RazorConfigurationSection : ConfigurationSection
	{
		...
		public Boolean DisableAutoIncludeModelNamespace
		{
			get
			{
				return (Boolean)this["disableAutoIncludeModelNamespace"];
			}
			set
			{
				this["disableAutoIncludeModelNamespace"] = value;
			}
		}
		...
		public NamespaceConfigurationCollection Namespaces
		{
			get
			{
				return this["namespaces"] as NamespaceConfigurationCollection;
			}
			set
			{
	...
	public sealed class NamespaceConfigurationItem : ConfigurationElement
	{
		...
		public string NamespaceName
		{
			get
			{
				return this[NamespacePropertyName] as string;
			}
			set
			{
				this[NamespacePropertyName] = value;
			}
		}
	}
