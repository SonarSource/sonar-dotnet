...
{
    [TestClass]
    public class ExecutingOsCommandsTest
    {
        [TestMethod]
        [TestCategory("Rule")]
        ...
        [TestMethod]
        [TestCategory("Rule")]
        public void ExecutingOsCommands_CS_Disabled()
        {
            Verifier.VerifyNoIssueReported(@"TestCases\ExecutingOsCommands.cs",
                new CSharp.ExecutingOsCommands());
        }
        ...
        [TestMethod]
        [TestCategory("Rule")]
        public void ExecutingOsCommands_VB_Disabled()
        {
            Verifier.VerifyNoIssueReported(@"TestCases\ExecutingOsCommands.vb",
                new VisualBasic.ExecutingOsCommands());
        }
    }
}
