 ...
 \*/";
        ...
        public void CheckFileLicense_WhenEmptyFile_ShouldBeNonCompliant_CS()
        {
            ...
            action.Should().Throw<UnexpectedDiagnosticException>()
                  .WithMessage($"Primary issue with message 'Add or update the header of this file.' not expected on line 1.{Environment.NewLine}See output to see all actual diagnostics raised on the file");
        }
