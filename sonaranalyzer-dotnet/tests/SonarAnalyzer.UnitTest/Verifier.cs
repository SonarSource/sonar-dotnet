...
namespace SonarAnalyzer.UnitTest
{
    internal static class Verifier
    {
        ...
        internal static readonly MetadataReference XunitCoreAssembly =
            MetadataReference.CreateFromFile(Constants.NuGetPackagesFolderRelativePath + @"\xunit.extensibility.core.2.2.0\lib\netstandard1.1\xunit.core.dll");
        internal static readonly MetadataReference XunitAssertAssembly =
            MetadataReference.CreateFromFile(Constants.NuGetPackagesFolderRelativePath + @"\xunit.assert.2.2.0\lib\netstandard1.1\xunit.assert.dll");
        internal static readonly MetadataReference NUnitFrameworkAssembly =
            MetadataReference.CreateFromFile(Constants.NuGetPackagesFolderRelativePath + @"\NUnit.2.6.4\lib\nunit.framework.dll");
