    ...
    public class Class1
    {
        ...
        public string Foo(string s)
        {
            ...
            other.ObjectProperty = other.Property;
                // %17 := Namespace.Class1.Property.get [ other ]
                // %16 := Namespace.Class1.ObjectProperty.set [ other %17 ]
...
namespace Namespace
{
    public class Class1
    {
        ...
        public void Foo()
        {
            ...
            Bar(this.Property);
                // %5 := Namespace.Class1.Property.get [ this ]
                // %4 := Namespace.Class1.Bar(int) [ this %5 ]
...
namespace Namespace
{
    public class Class1
    {
        ...
        public void Foo()
        {
            Property.Property.Property = new Class1();      // %0 := new Namespace.Class1
                                                            // %1 := Namespace.Class1.Class1() [ %0 ]
                                                            // %4 := Namespace.Class1.Property.get [ this ]
                                                            // %3 := Namespace.Class1.Property.get [ %4 ]
                                                            // %2 := Namespace.Class1.Property.set [ %3 %0 ]

            Class1.StaticProperty.Property = new Class1();  // %5 := new Namespace.Class1
                                                            // %6 := Namespace.Class1.Class1() [ %5 ]
                                                            // %8 := Namespace.Class1.StaticProperty.get [ Namespace.Class1 ]
                                                            // %7 := Namespace.Class1.Property.set [ %8 %5 ]
        }
    }
}";
            UcfgVerifier.VerifyInstructions(code, "Foo");
    ...
    public class Class1
    {
        ...
        public void Foo(Class1 other, string s)
        {
            other.ArrayProperty[0].arrayField[1].stringField = s;
                // %1 := Namespace.Class1.ArrayProperty.get [ other ]
                // %0 := __arrayGet [ %1 ]
                // %3 := __id [ %0.arrayField ]
                // %2 := __arrayGet [ %3 ]
...
namespace Namespace
{
    public class Class1
    {
        public void Foo(Class1 some, Class1 other)
        {
            int x;

            x = 1 + 2;
                // %0 := int.operator +(int, int) [ int const const ]
                // x := __id [ %0 ]

            x = 1 - 2;
                // %1 := int.operator -(int, int) [ int const const ]
                // x := __id [ %1 ]

            x = 1 * 2;
                // %2 := int.operator *(int, int) [ int const const ]
                // x := __id [ %2 ]

            x = 1 / 2;
                // %3 := int.operator /(int, int) [ int const const ]
                // x := __id [ %3 ]

            var result = some + other;
                // %4 := Namespace.Class1.operator +(Namespace.Class1, Namespace.Class1) [ Namespace.Class1 some other ]
                // result := __id [ %4 ]
        }
