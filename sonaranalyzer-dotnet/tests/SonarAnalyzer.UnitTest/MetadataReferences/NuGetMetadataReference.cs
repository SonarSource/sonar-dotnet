...
namespace SonarAnalyzer.UnitTest.MetadataReferences
{
    internal static class NuGetMetadataReference
    {
        ...
        public static References MicrosoftVisualStudioQualityToolsUnitTestFramework => CreateWithCommandLine("VS.QualityTools.UnitTestFramework", "15.0.27323.2");
        public static References MSTestTestFrameworkV1 => CreateWithCommandLine("MSTest.TestFramework", "1.1.11");
        ...
        public static References BouncyCastle(string packageVersion = "1.8.5") => CreateWithCommandLine("BouncyCastle", packageVersion);
        ...
        public static References MicrosoftAspNetCoreHosting(string packageVersion) => CreateWithCommandLine("Microsoft.AspNetCore.Hosting", packageVersion);
        public static References MicrosoftAspNetCoreHostingAbstractions(string packageVersion) => CreateWithCommandLine("Microsoft.AspNetCore.Hosting.Abstractions", packageVersion);
        public static References MicrosoftAspNetCoreHttpAbstractions(string packageVersion = "2.2.0") => CreateWithCommandLine("Microsoft.AspNetCore.Http.Abstractions", packageVersion);
        ...
        public static References MicrosoftAspNetCoreMvcCore(string packageVersion) => CreateWithCommandLine("Microsoft.AspNetCore.Mvc.Core", packageVersion);
        public static References MicrosoftAspNetCoreMvcViewFeatures(string packageVersion) => CreateWithCommandLine("Microsoft.AspNetCore.Mvc.ViewFeatures", packageVersion);
        ...
        public static References MicrosoftExtensionsConfigurationAbstractions(string packageVersion) => CreateWithCommandLine("Microsoft.Extensions.Configuration.Abstractions", packageVersion);
        public static References MicrosoftExtensionsDependencyInjectionAbstractions(string packageVersion) => CreateWithCommandLine("Microsoft.Extensions.DependencyInjection.Abstractions", packageVersion);
        public static References MicrosoftExtensionsLoggingPackages(string packageVersion) =>
            CreateWithCommandLine("Microsoft.Extensions.Logging", packageVersion)
            .Concat(CreateWithCommandLine("Microsoft.Extensions.Logging.AzureAppServices", packageVersion))
            .Concat(CreateWithCommandLine("Microsoft.Extensions.Logging.Abstractions", packageVersion))
            .Concat(CreateWithCommandLine("Microsoft.Extensions.Logging.Console", packageVersion))
            .Concat(CreateWithCommandLine("Microsoft.Extensions.Logging.Debug", packageVersion))
            .Concat(CreateWithCommandLine("Microsoft.Extensions.Logging.EventLog", packageVersion));
        public static References MicrosoftExtensionsOptions(string packageVersion) => CreateWithCommandLine("Microsoft.Extensions.Options", packageVersion);
        public static References MicrosoftExtensionsPrimitives(string packageVersion) => CreateWithCommandLine("Microsoft.Extensions.Primitives", packageVersion);
        ...
        public static References RestSharp(string packageVersion) => CreateWithCommandLine("RestSharp", packageVersion);
        public static References SerilogPackages(string packageVersion) =>
            CreateWithCommandLine("Serilog", packageVersion)
            .Concat(CreateWithCommandLine("Serilog.Sinks.Console", packageVersion));
        ...
        public static References SystemCollectionsImmutable(string packageVersion) => CreateWithCommandLine("System.Collections.Immutable", packageVersion);
        ...
        public static References SystemSecurityCryptographyOpenSsl(string packageVersion = "4.7.0") => CreateWithCommandLine("System.Security.Cryptography.OpenSsl", packageVersion);
        ...
        public static References SystemThreadingTasksExtensions(string packageVersion) => CreateWithCommandLine("System.Threading.Tasks.Extensions", packageVersion);
        public static References SystemValueTuple(string packageVersion) => CreateWithCommandLine("System.ValueTuple", packageVersion);
        ...
        public static References XunitFramework(string packageVersion) =>
            CreateWithCommandLine("xunit.assert", packageVersion)
            .Concat(CreateWithCommandLine("xunit.extensibility.core", packageVersion));
    }
}
