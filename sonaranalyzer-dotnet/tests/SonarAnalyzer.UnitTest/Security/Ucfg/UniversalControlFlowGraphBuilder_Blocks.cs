...
namespace Namespace
{
    ...
    public class Class1
    {
        ...
        {
            if (string.IsNullOrEmpty(s))    // Branch (Next:Jump,Simple)     |   Basic0(Jump:1,2)
...
namespace Namespace
{
    ...
    public class Class1
    {
        ...
        private void ValidateRetBlock(BasicBlock block, string expectedId, string expectedReturnExpression = null)
        {
            ...
            {
                block.Ret.ReturnedExpression.Const?.Value.Should().Be(UniversalControlFlowGraphBuilder.Const);
            }
            else
            {
