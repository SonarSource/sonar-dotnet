...
public static class Extensions
{
    public static void Extension(this string s, int x) { }
            ...
            string GetMethodId(string methodName, int skip = 0) =>
                UcfgIdentifier.CreateMethodId(semanticModel.GetDeclaredSymbol(syntaxTree.GetMethod(methodName, skip))).ToString();
        }
...
public class Class3
{
    public string Property6 { get; set; }
            ...
            string PropertyGetId(string propertyName, int skip = 0) =>
                UcfgIdentifier.CreateMethodId(semanticModel.GetDeclaredSymbol(syntaxTree.GetProperty(propertyName, skip)).GetMethod).ToString();

            string PropertySetId(string propertyName, int skip = 0) =>
                UcfgIdentifier.CreateMethodId(semanticModel.GetDeclaredSymbol(syntaxTree.GetProperty(propertyName, skip)).SetMethod).ToString();
        }
...
";
            ...
            string CtorId(string className, int skip = 0) =>
                UcfgIdentifier.CreateMethodId(semanticModel.GetDeclaredSymbol(syntaxTree.GetConstructor(className, skip))).ToString();
        }
