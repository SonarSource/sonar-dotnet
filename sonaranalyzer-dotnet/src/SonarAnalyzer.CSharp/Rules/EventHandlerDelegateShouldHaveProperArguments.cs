            ...
            context.RegisterSyntaxNodeActionInNonGenerated(c =>
                {
                    ...
                    {
                        c.CheckReportDiagnostic(Diagnostic.Create(rule, invocation.GetLocation(), NullEventArgsMessage));
                    }
                    ...
                    {
                        c.CheckReportDiagnostic(Diagnostic.Create(rule, invocation.GetLocation(), NullSenderMessage));
                    }
                    else if (!isFirstParameterNull && eventSymbol.IsStatic)
                    {
                        c.CheckReportDiagnostic(Diagnostic.Create(rule, invocation.GetLocation(), NonNullSenderMessage));
                    }
                },
