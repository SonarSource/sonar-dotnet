...
namespace SonarAnalyzer.Rules.CSharp
{
    ...
    public sealed class DoNotCopyArraysInProperties : SonarDiagnosticAnalyzer
    {
        ...
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics => ImmutableArray.Create(s2365);
        ...
        protected override void Initialize(SonarAnalysisContext context)
        {
            context.RegisterSyntaxNodeActionInNonGenerated(c =>
            {
                ...
                {
                    c.CheckReportDiagnostic(Diagnostic.Create(s2365, location, property.Identifier.Text));
                }
