...
namespace SonarAnalyzer.Rules.CSharp
{
    ...
    public class ClassAndMethodName : SonarDiagnosticAnalyzer
    {
        ...
        private static void CheckTypeName(SyntaxNodeAnalysisContext context)
        {
            ...
            {
                context.CheckReportDiagnostic(Diagnostic.Create(rule_TypeName, identifier.GetLocation(),
            ...
            SyntaxNodeAnalysisContext context)
        {
            ...
            if (identifier.ValueText.StartsWith("_", StringComparison.Ordinal) ||
                identifier.ValueText.EndsWith("_", StringComparison.Ordinal))
            {
                context.CheckReportDiagnostic(Diagnostic.Create(rule_MethodName, identifier.GetLocation(),
