...
namespace SonarAnalyzer.Rules.CSharp
{
    ...
    public class RedundancyInConstructorDestructorDeclaration : SonarDiagnosticAnalyzer
    {
        ...
        private static void CheckDestructorDeclaration(SyntaxNodeAnalysisContext context)
        {
            ...
            {
                Diagnostic.Create(rule, destructorDeclaration.GetLocation(), "destructor").ReportFor(context);
            }
        }
        ...
        private static void CheckConstructorDeclaration(SyntaxNodeAnalysisContext context)
        {
            ...
            {
                Diagnostic.Create(rule, constructorDeclaration.GetLocation(), "constructor").ReportFor(context);
                return;
            }
            ...
            {
                Diagnostic.Create(rule, initializer.GetLocation(), "'base()' call").ReportFor(context);
            }
        }
