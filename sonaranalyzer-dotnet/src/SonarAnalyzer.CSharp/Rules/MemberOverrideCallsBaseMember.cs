        ...
        protected sealed override void Initialize(SonarAnalysisContext context)
        {
            context.RegisterSyntaxNodeActionInNonGenerated(
                c =>
                {
                    ...
                    {
                        c.CheckReportDiagnostic(Diagnostic.Create(rule, method.GetLocation(), method.Identifier.ValueText, "method"));
                    }
                },
            ...
            context.RegisterSyntaxNodeActionInNonGenerated(
                c =>
                {
                    ...
                    {
                        c.CheckReportDiagnostic(Diagnostic.Create(rule, property.GetLocation(), property.Identifier.ValueText, "property"));
                    }
                },
