...
namespace SonarAnalyzer.Rules.CSharp
{
    ...
    [Rule(DiagnosticId)]
    public sealed class StringFormatTypoFreeValidator : StringFormatValidatorBase
    {
        ...
        private static readonly ISet<ValidationFailure.FailureKind> failuresToReportOn =
            ...
            {
                ValidationFailure.FailureKind.SimpleString,
                ValidationFailure.FailureKind.MissingFormatItemIndex,
                ValidationFailure.FailureKind.UnusedFormatArguments
            };
