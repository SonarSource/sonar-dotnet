    ...
    public sealed class UseUriInsteadOfString : SonarDiagnosticAnalyzer
    {
        ...
        private void VerifyMethodDeclaration(SyntaxNodeAnalysisContext context)
        {
            ...
            if (methodOverloads.Any())
            {
                ...
                {
                    context.CheckReportDiagnostic(Diagnostic.Create(rule_S3997, methodDeclaration.FindIdentifierLocation()));
                }
            }
            else
            {
                ...
                {
                    context.CheckReportDiagnostic(Diagnostic.Create(rule_S3994,
        ...
        private void VerifyPropertyDeclaration(SyntaxNodeAnalysisContext context)
        {
            ...
            {
                context.CheckReportDiagnostic(Diagnostic.Create(rule_S3996, propertyDeclaration.Type.GetLocation()));
            }
        }
        ...
        private void VerifyInvocationAndCreation(SyntaxNodeAnalysisContext context)
        {
            ...
            {
                context.CheckReportDiagnostic(Diagnostic.Create(rule_S4005, context.Node.GetLocation()));
            }
        }
            ...
            BaseMethodDeclarationSyntax methodDeclaration, IMethodSymbol methodSymbol)
        {
            ...
            {
                context.CheckReportDiagnostic(Diagnostic.Create(rule_S3995, returnTypeLocation));
            }
        }
