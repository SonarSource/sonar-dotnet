...
namespace SonarAnalyzer.Rules.CSharp
{
    ...
    [Rule(DiagnosticId)]
    public class RedundantParenthesesObjectsCreation : SonarDiagnosticAnalyzer
    {
        internal const string DiagnosticId = "S3235";
        private const string MessageFormat = "Remove these redundant parentheses.";

        private static readonly DiagnosticDescriptor rule =
            DiagnosticDescriptorBuilder.GetDescriptor(DiagnosticId, MessageFormat, IdeVisibility.Hidden, RspecStrings.ResourceManager);
        ...
        protected sealed override void Initialize(SonarAnalysisContext context)
        {
            context.RegisterSyntaxNodeActionInNonGenerated(
                c =>
                {
                    ...
                    {
                        Diagnostic.Create(rule, argumentList.GetLocation()).ReportFor(c);
                    }
                },
