        ...
        protected override void Initialize(SonarAnalysisContext context)
        {
            context.RegisterSyntaxNodeActionInNonGenerated(
                c =>
                {
                    ...
                    {
                        Diagnostic.Create(rule, operands.Left.GetLocation(),                            additionalLocations: new[] { operands.Right.GetLocation() },                            messageArgs: new[] { operands.Right.ToString(), operands.ErrorMessage }).ReportFor(c);
                    }
