 ...
 \*/";
        ...
        public void CheckFileLicense_WhenProvidingAnInvalidRegex_ShouldThrowException()
        {
            ...
            const string expectedErrorMessage =
                ...
                "'SonarAnalyzer.Rules.CSharp.CheckFileLicense' threw an exception of type 'System.ArgumentException' " +
                "with message 'Invalid regular expression: " + FailingSingleLineRegexHeader  + "\r\n* headerFormat'.}.";
#else
            const string expectedErrorMessage =
