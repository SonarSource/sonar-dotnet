...
//          ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
            ...
            NUnit.Framework.Assert.False(true, b); // Noncompliant
            NUnit.Framework.Assert.IsFalse(true, b); // Noncompliant
            NUnit.Framework.Assert.IsTrue(true, b); // Noncompliant
            NUnit.Framework.Assert.That(true, b); // Noncompliant
            NUnit.Framework.Assert.True(true, b); // Noncompliant
            ...
            Xunit.Assert.Equals(true, b); // Noncompliant
            Xunit.Assert.False(true, b); // Noncompliant
            ...
            Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsFalse(true, b); // Noncompliant
            Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(true, b); // Noncompliant
            ...
            Xunit.Assert.True(true, b); // There is no Assert.Fail in Xunit. Assert.True(false) is way to simulate it.
            Xunit.Assert.True(b, false);
        }
    }
}
