...
namespace SonarAnalyzer.Rules.VisualBasic
{
    ...
    public sealed class UseArrayEmpty : UseArrayEmptyBase<SyntaxKind, ObjectCreationExpressionSyntax, CollectionInitializerSyntax>
    {
        ...
        protected override bool IsEmptyCreation(ObjectCreationExpressionSyntax node)
        {
            var simpleArgument = node?.ChildNodes().OfType<ArgumentListSyntax>().FirstOrDefault()?.Arguments.Cast<SimpleArgumentSyntax>().FirstOrDefault();
