...
/**
 * Code of the AbstractTokenizer adapted to the C# language.
 * It was impossible to extend AbstractTokenizer, some private methods
...
public class CsTokenizer implements Tokenizer {
	...
	private List<String> stringToken;			// List<String>, should be setted by children classes
	private List<String> ignorableCharacter; 	// List<String>, should be setted by children classes
												// FIXME:Maybe an array of 'char' would be better for perfomance ?
	private List<String> ignorableStmt; 		// List<String>, should be setted by children classes
