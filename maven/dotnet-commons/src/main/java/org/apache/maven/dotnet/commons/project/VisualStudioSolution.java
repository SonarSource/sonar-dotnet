...
public class VisualStudioSolution {
   ...
   * @param skippedProjects  List of the excluded projects, using ',' as delimiter
   */
  ...
  /**
   * Override default locations for the assemblies 
   * generated by the solution
   * 
   * @param assemblyDirectories A map where keys are project 
   *                            names and values path to the generated assemblies?
   */
