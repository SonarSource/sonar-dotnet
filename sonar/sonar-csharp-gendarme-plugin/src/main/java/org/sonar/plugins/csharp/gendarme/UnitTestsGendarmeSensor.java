...
public class UnitTestsGendarmeSensor extends GendarmeSensor {

  public UnitTestsGendarmeSensor(ProjectFileSystem fileSystem, RulesProfile rulesProfile, GendarmeProfileExporter profileExporter,
  ...
  protected String getRepositoryKey() {
    return GendarmeConstants.TEST_REPOSITORY_KEY;
  }
