...
public class SourceMonitorResultParser
{
  ...
  private FileMetrics createMetrics(Element fileNode)
  {
    ...
    double percentCommentLines = getDoubleMetric(fileNode, "metrics/metric[@id='M2']");
    double percentDocumentationLines = getDoubleMetric(fileNode, "metrics/metric[@id='M3']");
    ...
    int countMethodStatements = getIntMetric(fileNode, "metrics/metric[@id='M7']");
    double averageComplexity = getDoubleMetric(fileNode, "metrics/metric[@id='M14']");
