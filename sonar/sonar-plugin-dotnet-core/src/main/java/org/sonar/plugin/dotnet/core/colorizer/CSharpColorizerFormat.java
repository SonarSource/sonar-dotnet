...
public class CSharpColorizerFormat extends CodeColorizerFormat {
	...
	static {
		...
		keywords.addAll(Arrays.asList(new String[] { "abstract", "add", "as",
				"ascending", "base", "bool", "break", "by", "byte", "case",
				"catch", "char", "checked", "class", "const", "continue",
				"decimal", "default", "delegate", "do", "double", "descending",
				"else", "enum", "event", "explicit", "extern", "false",
				"finally", "fixed", "from", "float", "for", "foreach", "get",
				"group", "goto", "if", "implicit", "in", "int", "into",
				"interface", "internal", "is", "lock", "long", "join", "let",
				"namespace", "new", "null", "object", "operator", "orderby",
	...
	public List<Tokenizer> getTokenizers() {
		 return Collections.unmodifiableList(Arrays.asList(
			      ...
			      new XmlDocTokenizer("<span class=\"cppd\">", "</span>"),
