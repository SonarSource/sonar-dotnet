...
public class UnitTestsFxCopSensor extends FxCopSensor {

  public UnitTestsFxCopSensor(ProjectFileSystem fileSystem, RulesProfile rulesProfile, FxCopProfileExporter profileExporter,
  ...
  protected String getRepositoryKey() {
    return FxCopConstants.TEST_REPOSITORY_KEY;
  }
