 ...
 * report file.
 */
public class ItCoverageDecorator implements Decorator {

  private static final Logger LOG = LoggerFactory.getLogger(ItCoverageDecorator.class);
  ...
  public void decorate(Resource resource, DecoratorContext context) {
    if (ResourceUtils.isFile(resource) && context.getMeasure(CoreMetrics.IT_COVERAGE) == null) {
