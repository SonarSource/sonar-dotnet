 ...
 */
public class StyleCopUnitTestsRuleRepository extends RuleRepository {

  // for user extensions
  private ServerFileSystem fileSystem;
  private XMLRuleParser xmlRuleParser;

  public StyleCopUnitTestsRuleRepository(ServerFileSystem fileSystem, XMLRuleParser xmlRuleParser) {
    super(StyleCopConstants.TEST_REPOSITORY_KEY, CSharpConstants.LANGUAGE_KEY);
    setName(StyleCopConstants.TEST_REPOSITORY_NAME);
