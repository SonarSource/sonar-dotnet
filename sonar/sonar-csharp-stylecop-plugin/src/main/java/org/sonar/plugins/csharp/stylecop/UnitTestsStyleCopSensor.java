...
public class UnitTestsStyleCopSensor extends StyleCopSensor {

  public UnitTestsStyleCopSensor(ProjectFileSystem fileSystem, RulesProfile rulesProfile, StyleCopProfileExporter profileExporter,
  ...
  protected String getRepositoryKey() {
    return StyleCopConstants.TEST_REPOSITORY_KEY;
  }
