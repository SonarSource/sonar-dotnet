...
public class LockStatementTest extends RuleTest {

  @Before
  public void init() {
    p.setRootRule(p.getGrammar().rule(CSharpGrammarImpl.lockStatement));
  ...
  public void ok() {
    assertThat(p)
        .matches("lock (expression) embeddedStatement");
  }
