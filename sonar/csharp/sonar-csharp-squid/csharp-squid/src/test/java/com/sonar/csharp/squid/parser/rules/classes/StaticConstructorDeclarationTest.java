...
public class StaticConstructorDeclarationTest extends RuleTest {
  ...
  public void ok() {
    assertThat(p)
        .matches("attributes staticConstructorModifiers id () staticConstructorBody")
        .matches("staticConstructorModifiers id () staticConstructorBody");
  }
