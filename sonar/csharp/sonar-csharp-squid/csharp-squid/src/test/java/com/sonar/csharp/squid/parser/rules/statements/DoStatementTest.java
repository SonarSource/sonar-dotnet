...
public class DoStatementTest extends RuleTest {

  @Before
  public void init() {
    p.setRootRule(p.getGrammar().rule(CSharpGrammarImpl.doStatement));
  ...
  public void ok() {
    assertThat(p)
        .matches("do embeddedStatement while ( expression ) ;");
  }
