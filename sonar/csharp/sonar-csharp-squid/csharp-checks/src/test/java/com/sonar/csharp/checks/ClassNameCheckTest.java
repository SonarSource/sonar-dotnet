...
public class ClassNameCheckTest {
  ...
  public void test() {
    ...
    checkMessagesVerifier.verify(file.getCheckMessages())
        .next().atLine(3).withMessage("Rename this class name to match the regular expression [A-HJ-Z][a-zA-Z]++|I[a-z][a-zA-Z]*+")
        .next().atLine(11)
        .next().atLine(15);
  }
  ...
  public void custom() {
    ...
    checkMessagesVerifier.verify(file.getCheckMessages())
        .next().atLine(3).withMessage("Rename this class name to match the regular expression IFoo")
        .next().atLine(7)
        .next().atLine(11)
        .next().atLine(19);
  }
