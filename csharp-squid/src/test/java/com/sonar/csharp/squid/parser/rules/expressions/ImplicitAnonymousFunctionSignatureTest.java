...
public class ImplicitAnonymousFunctionSignatureTest extends RuleTest {
  ...
  public void ok() {
    assertThat(p)
        .matches("()")
        .matches("(implicitAnonymousFunctionParameter)")
        .matches("(implicitAnonymousFunctionParameter, implicitAnonymousFunctionParameter)")
        .matches("implicitAnonymousFunctionParameter");
  }
