...
public class GeneratedFileFilterTest {
  ...
  public void accept_returns_false_for_autogenerated_files() throws IOException {
    // Arrange
    GeneratedFileFilter filter = createFilter(Paths.get("autogenerated"), defaultConfiguration);
  ...
  public void accept_returns_true_for_nonautogenerated_files() throws IOException {
    // Arrange
    GeneratedFileFilter filter = createFilter(Paths.get("c:\\autogenerated"), defaultConfiguration);
  ...
  public void accept_returns_true_for_autogenerated_files_when_analyzeGeneratedCode_setting_true() throws IOException {
    ...
    GeneratedFileFilter filter = createFilter(Paths.get("autogenerated"), mockConfiguration);
  ...
  private GeneratedFileFilter createFilter(Path generated, AbstractSolutionConfiguration configuration) throws IOException {
