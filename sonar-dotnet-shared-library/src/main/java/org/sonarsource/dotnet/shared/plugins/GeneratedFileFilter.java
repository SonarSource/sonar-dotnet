...
public class GeneratedFileFilter implements InputFileFilter {
  ...
  private Set<String> generatedFilePaths;
  ...
  public boolean accept(InputFile inputFile) {
    ...
    boolean isGenerated = generatedFilePaths.contains(inputFile.absolutePath());
    if (isGenerated) {
      LOG.info("Skipping autogenerated file: {}", inputFile.absolutePath());
    }
    return !isGenerated;
  }
  ...
  private synchronized void initOnce() {
    ...
    if (protobufPath.toFile().exists()) {
      ...
      generatedFilePaths = new HashSet<>();
    }
  }
}
