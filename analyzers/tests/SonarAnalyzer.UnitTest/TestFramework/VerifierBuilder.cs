    ...
    internal record VerifierBuilder
    {
        ...
        public VerifierBuilder AddPaths(params string[] paths) =>
            this with
            {
                ...
                IsRazor = IsRazor || Array.Exists(paths, x => x.EndsWith(".razor", StringComparison.InvariantCultureIgnoreCase) || x.EndsWith(".cshtml", StringComparison.InvariantCultureIgnoreCase))
            };
