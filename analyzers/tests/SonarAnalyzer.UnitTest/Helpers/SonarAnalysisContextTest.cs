...
namespace SonarAnalyzer.UnitTest.Helpers
{
    ...
    public partial class SonarAnalysisContextTest
    {
        ...
        [DataTestMethod]
        [DataRow("snippet1.cs", true)]
        [DataRow("Other file is unchanged.cs", false)]
        public void RegisterSyntaxNodeAction_UnchangedFiles_GeneratedFile(string unchangedFileName, bool expectedEmptyResult)
        {
            var builder = new VerifierBuilder<DummyAnalyzerForGenerated>()
