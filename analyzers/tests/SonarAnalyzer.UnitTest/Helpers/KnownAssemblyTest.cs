...
public class KnownAssemblyTest
{
    ...
    public void NameIs_Test(string name, bool expected)
    {
        ...
        var compilation = MockCompilation(identity);
    ...
    public void NameContains_Test(string name, bool expected)
    {
        ...
        var compilation = MockCompilation(new AssemblyIdentity(name));
        sut.IsReferencedBy(compilation.Object).Should().Be(expected);
    }
    ...
    {
        var compilation = MockCompilation(new AssemblyIdentity("assemblyName", new Version(version)));
    ...
    {
        var compilation = MockCompilation(new AssemblyIdentity("assemblyName", hasPublicKey: false));
    ...
    {
        var compilation = MockCompilation(new AssemblyIdentity(name, new Version(version)));
    ...
    private static Mock<Compilation> MockCompilation(AssemblyIdentity identity)
    {
