...
//                      ^^^^^^^^^^^^^^^^^^^^
    ...
    public partial class LibraryImportAttributeImports
    {
        ...
        // Provide the implementation part useally generated by the code generator
        public static partial int CoInitializeSecurity(nint pVoid, int cAuthSvc, nint asAuthSvc, nint pReserved1, RpcAuthnLevel level, RpcImpLevel impers, nint pAuthList, EoAuthnCap dwCapabilities, nint pReserved3) => 1;
