...
namespace Tests.Diagnostics
{
    ...
    {
        public static ISet<string> iSetInitializaedWithImmutableSet = ImmutableHashSet.Create("a", "b"); // Noncompliant {{Use an immutable collection or reduce the accessibility of the public static field(s) 'iSetInitializaedWithImmutableSet'.}}
//                    ^^^^^^^^^^^^
    ...
    {
        public static ISet<string> set1, set2; // Noncompliant {{Use an immutable collection or reduce the accessibility of the public static field(s) 'set1' and 'set2'.}}
    }
