...
public class UseCachedRegex
{
    ...
    void Noncompliant()
    {
        ...
        myRegex = true ? new Regex("^[a-zA-Z]$") : false ? new Regex("^[0-9]$") : new Regex("^[a-zA-Z0-9]$");
        //               ^^^^^^^^^^^^^^^^^^^^^^^
        //                                                 ^^^^^^^^^^^^^^^^^^^^@-1
        //                                                                        ^^^^^^^^^^^^^^^^^^^^^^^^^^@-2
        MutableCachedRegex = MutableCachedRegex != null ? MutableCachedRegex : false ? new Regex("^[a-zA-Z]$") : new Regex("^[0-9]$"); // FP
        //                                                                             ^^^^^^^^^^^^^^^^^^^^^^^
        //                                                                                                       ^^^^^^^^^^^^^^^^^^^^@-1
