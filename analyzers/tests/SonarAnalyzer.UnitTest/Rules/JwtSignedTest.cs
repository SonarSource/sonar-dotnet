...
namespace SonarAnalyzer.UnitTest.Rules
{
    ...
    public class JwtSignedTest
    {
        ...
        public void JwtSigned_JWTDecoderExtensions_CS() =>
            Verifier.VerifyAnalyzer(@"TestCases\JwtSigned.JwtDecoderExtensionsAPI.cs", new csharp.JwtSigned(), additionalReferences: NuGetMetadataReference.JWT("7.3.1"));
        ...
        public void JwtSigned_JWTDecoderExtensions_VB() =>
            Verifier.VerifyAnalyzer(@"TestCases\JwtSigned.JwtDecoderExtensionsAPI.vb", new vbnet.JwtSigned(), additionalReferences: NuGetMetadataReference.JWT("7.3.1"));
    }
}
