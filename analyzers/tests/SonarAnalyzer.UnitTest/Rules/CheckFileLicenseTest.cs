...
";
 ...
 \*/";
        ...
        public void CheckFileLicense_WhenNoLicenseStartingWithNamespace_ShouldBeNonCompliant_CS() =>
            Verifier.VerifyNonConcurrentAnalyzer(@"TestCases\CheckFileLicense_NoLicenseStartWithNamespace.cs", new CS.CheckFileLicense { HeaderFormat = SingleLineHeader });
        ...
        public void CheckFileLicense_WhenLicensedWithMultiSingleLineCommentStartingWithAdditionalCommentOnSameLine_ShouldBeNonCompliant_CS() =>
            Verifier.VerifyNonConcurrentAnalyzer(@"TestCases\CheckFileLicense_MultiSingleLineLicenseStartWithAdditionalCommentOnSameLine.cs",
                                                 new CS.CheckFileLicense { HeaderFormat = MultiSingleLineCommentHeader });

        [TestMethod]
        [TestCategory("Rule")]
        public void CheckFileLicense_WithForcingEmptyLines_ShouldBeNonCompliant_CS() =>
            Verifier.VerifyNonConcurrentAnalyzer(@"TestCases\CheckFileLicense_ForcingEmptyLinesKo.cs", new CS.CheckFileLicense { HeaderFormat = HeaderForcingLineBreak });
        ...
        {
            Action action =
                () => Verifier.VerifyNonConcurrentAnalyzer(@"TestCases\CheckFileLicense_EmptyFile.cs", new CS.CheckFileLicense { HeaderFormat = SingleLineHeader });
        ...
        public void CheckFileLicenseCodeFix_WhenThereIsAYearDifference_ShouldBeNonCompliant_CS() =>
            Verifier.VerifyNonConcurrentAnalyzer(@"TestCases\CheckFileLicense_YearDifference.cs", new CS.CheckFileLicense { HeaderFormat = MultiLineHeader });

        [TestMethod]
        [TestCategory("Rule")]
        public void CheckFileLicense_WhenProvidingAnInvalidRegex_ShouldThrowException_CS()
        {
            Action action = () => Verifier.VerifyNonConcurrentAnalyzer(@"TestCases\CheckFileLicense_NoLicenseStartWithUsing.cs",
                                                                       new CS.CheckFileLicense { HeaderFormat = FailingSingleLineRegexHeader, IsRegularExpression = true });
        ...
        public void CheckFileLicense_Compliant_VB() =>
            Verifier.VerifyNonConcurrentAnalyzer(@"TestCases\CheckFileLicense_Compliant.vb",
                new VB.CheckFileLicense
                {
