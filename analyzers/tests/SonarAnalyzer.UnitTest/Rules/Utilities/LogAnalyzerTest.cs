    ...
    public class LogAnalyzerTest
    {
        ...
        public void LogAutogenerated_Razor()
        {
            ...
            CreateBuilder("Generated_razor.g.cs")
                .WithSonarProjectConfigPath(AnalysisScaffolding.CreateSonarProjectConfig(TestContext, ProjectType.Product))
                .VerifyUtilityAnalyzer<LogInfo>(logs =>
                                                {
                                                    logs.Select(x => x.Text).Should().Contain($"File 'Utilities\\LogAnalyzer\\Generated_razor.g.cs' was recognized as razor generated");
                                                });
        }
