...
namespace SonarAnalyzer.UnitTest.Rules
{
    ...
    public class TokenTypeAnalyzerTest
    {
        ...
        public void Verify_Identifiers_CS(ProjectType projectType) =>
            ...
            {
                info.Should().HaveCount(49);
                info.Count(x => x.TokenType == TokenType.Keyword).Should().Be(33);
                info.Count(x => x.TokenType == TokenType.TypeName).Should().Be(13);
        ...
        {
            var builder = CreateBuilder(ProjectType.Product, "Tokens.cs").WithSonarProjectConfigPath(TestHelper.CreateSonarProjectConfigWithUnchangedFiles(TestContext, BasePath + unchangedFileName));
