...
namespace SonarAnalyzer.UnitTest.Rules
{
    ...
    public class FileMetadataAnalyzerTest
    {
        ...
        [DataRow(false)]
        [TestCategory("Rule")]
        public void Autogenerated(bool isTestProject)
        {
            ...
            VerifyAllFilesAreGenerated(nameof(Autogenerated), projectFiles, autogeneratedFiles, isTestProject);
        }
        ...
        [DataRow(false)]
        [TestCategory("Rule")]
        public void Autogenerated_CSharp9(bool isTestProject)
        {
            var autogeneratedFiles = new[]
            {
                @"ExtraEmptyFile.g.cs", // This is added by Verifier, we will skip it when building the project
            ...
            VerifyAllFilesAreGenerated(nameof(Autogenerated_CSharp9), projectFiles, autogeneratedFiles, isTestProject, ParseOptionsHelper.FromCSharp9);
        }
        ...
        [DataRow(false)]
        [TestCategory("Rule")]
        public void NotAutogenerated(bool isTestProject)
        {
            ...
            Verifier.VerifyUtilityAnalyzer<FileMetadataInfo>(
                projectFiles,
                new TestFileMetadataAnalyzer(testRoot, isTestProject),
                                                ...
                                                IEnumerable<ParseOptions> parseOptions = null)
        {
            ...
            void VerifyProtobuf(IReadOnlyList<FileMetadataInfo> messages)
            {
