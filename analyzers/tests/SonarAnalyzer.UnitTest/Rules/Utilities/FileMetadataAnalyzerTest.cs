        ...
        public void NotAutogenerated(ProjectType projectType)
        {
            ...
            CreateBuilder(projectType, notAutogeneratedFiles)
                ...
                .VerifyUtilityAnalyzer<FileMetadataInfo>(messages =>
                    messages.Should().HaveCount(notAutogeneratedFiles.Length + 1) // +1 for ExtraEmptyFile.g.cs
                    .And.Contain(new FileMetadataInfo { IsGenerated = true, FilePath = "ExtraEmptyFile.g.cs" })
                    .And.Contain(notAutogeneratedFiles.Select(expected => new FileMetadataInfo
                        {
                            IsGenerated = false,
