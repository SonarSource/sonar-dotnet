...
namespace SonarAnalyzer.UnitTest.Rules
{
    ...
    public class FileMetadataAnalyzerTest
    {
        ...
        public void NotAutogenerated(ProjectType projectType)
        {
            ...
            CreateBuilder(projectType == ProjectType.Test, notAutogeneratedFiles, BasePath + nameof(NotAutogenerated))
                ...
                .VerifyUtilityAnalyzer<FileMetadataInfo>(messages =>
                    {
                        ...
                        for (var i = 0; i < notAutogeneratedFiles.Length; i++)
                        {
                            ...
                            message.FilePath.Should().Be(BasePath + notAutogeneratedFiles[i]);
                        }
                    });
        }
        ...
        [DataTestMethod]
        [DataRow("class.generated.cs", 1)]  // ExtraEmptyFile.g.cs
        [DataRow("SomethingElse.cs", 2)]    // ExtraEmptyFile.g.cs and class.generated.cs
        public void Verify_UnchangedFiles(string unchangedFileName, int expectedFileCount) =>
            CreateBuilder(false, new[] { "class.generated.cs" }, BasePath + nameof(Verify_UnchangedFiles))
        ...
        private void VerifyAllFilesAreGenerated(string testName,
            ...
            CreateBuilder(projectType == ProjectType.Test, projectFiles, BasePath + testName)
                .WithSonarProjectConfigPath(TestHelper.CreateSonarProjectConfig(TestContext, projectType))
                .VerifyUtilityAnalyzer<FileMetadataInfo>(messages =>
                {
        ...
        private static VerifierBuilder CreateBuilder(bool isTestProject, string[] projectFiles, string testRoot) =>
            new VerifierBuilder()
                .AddAnalyzer(() => new TestFileMetadataAnalyzer(testRoot, isTestProject))
