...
public class SymbolicContextTest
{
    ...
    {
        var create = () => new SymbolicContext(CreateOperation(), null, Array.Empty<ISymbol>(), false);
    ...
    {
        var create = () => new SymbolicContext(CreateOperation(), ProgramState.Empty, null, false);
    ...
    public void NullOperation_SetsOperationToNull() =>
        new SymbolicContext(null, ProgramState.Empty, Array.Empty<ISymbol>(), false).Operation.Should().Be(null);
    ...
    public void PropertiesArePersisted()
    {
        ...
        var sut = new SymbolicContext(operation, state, Array.Empty<ISymbol>(), true);
    ...
    public void SetOperationConstraint_WithExistingValue()
    {
        ...
        var sut = new SymbolicContext(operation, state, Array.Empty<ISymbol>(), false);
    ...
    {
        var state = ProgramState.Empty;
        var sut = new SymbolicContext(null, state, Array.Empty<ISymbol>(), false);
