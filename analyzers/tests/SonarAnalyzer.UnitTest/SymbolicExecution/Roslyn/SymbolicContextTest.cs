...
public class SymbolicContextTest
{
    ...
    {
        var create = () => new SymbolicContext(CreateOperation(), null, Array.Empty<ISymbol>(), 0);
    ...
    {
        var create = () => new SymbolicContext(CreateOperation(), ProgramState.Empty, null, 0);
    ...
    public void NullOperation_SetsOperationToNull() =>
        new SymbolicContext(null, ProgramState.Empty, Array.Empty<ISymbol>(), 1).Operation.Should().Be(null);
    ...
    public void PropertiesArePersisted()
    {
        ...
        var sut = new SymbolicContext(operation, state, Array.Empty<ISymbol>(), 42);
    ...
    public void SetOperationConstraint_WithExistingValue()
    {
        ...
        var sut = new SymbolicContext(operation, state, Array.Empty<ISymbol>(), 0);
    ...
    {
        var state = ProgramState.Empty;
        var sut = new SymbolicContext(null, state, Array.Empty<ISymbol>(), 0);
