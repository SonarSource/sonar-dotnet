...
public partial class RoslynSymbolicExecutionTest
{
    ...
    [DataRow("|=", 43)]
    [DataRow("^=", 43)]
    public void CompoundAssignment_Arithmetics_Int(string op, int expected)
    {
        var code = $"""
            var value = 42;
    ...
    [DataRow(">>=")]
    [DataRow(">>>=")]
    public void CompoundAssignment_Arithmetics_Int_ShiftOperators(string op)
    {
        var code = $"""
            var value = 42;
            var result = value {op} 1;
    ...
    [DataRow(-5, 4, -20)]
    [DataRow(-5, -4, 20)]
    public void CompoundAssignment_Multiplication_SingleValue(int left, int right, int expected)
    {
        var code = $"""
            var left = {left};
            var right = {right};
