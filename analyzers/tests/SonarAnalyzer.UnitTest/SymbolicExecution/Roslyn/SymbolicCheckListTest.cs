...
public class SymbolicCheckListTest
{
    ...
    public void Notifications_ExecutedForAll()
    {
        ...
        var context = new SymbolicContext(null, ProgramState.Empty, false, 0, Array.Empty<ISymbol>());
    ...
    public void PostProcess_CanReturnMultipleStates()
    {
        ...
        sut.PostProcess(new(null, ProgramState.Empty, false, 0, Array.Empty<ISymbol>())).Should().HaveCount(9);
    }
    ...
    public void PostProcess_CanReturnNoStates()
    {
        ...
        sut.PostProcess(new(null, ProgramState.Empty, false, 0, Array.Empty<ISymbol>())).Should().HaveCount(0);
    }
}
