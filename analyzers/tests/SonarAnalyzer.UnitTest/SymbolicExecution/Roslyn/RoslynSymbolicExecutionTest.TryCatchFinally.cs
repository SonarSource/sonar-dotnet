...
tag = ""AfterCatch"";";
            ...
            validator.TagStates("InCatch").Should().HaveCount(1).And.ContainSingle(x => HasSystemException(x));
...
tag = ""AfterCatch"";";
            var validator = SETestContext.CreateCS(code, ", Exception ex").Validator;
            validator.ValidateTagOrder(
                "BeforeTry",
                "InTry",
                "InCatch",
