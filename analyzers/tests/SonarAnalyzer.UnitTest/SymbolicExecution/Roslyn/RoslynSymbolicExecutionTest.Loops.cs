...
Tag(""End"", value);";
        ...
        validator.TagValues("End").Should().HaveCount(2)
            .And.SatisfyRespectively(
                x => x.AllConstraints.Should().BeEquivalentTo(new SymbolicConstraint[] { ObjectConstraint.NotNull, NumberConstraint.From(42) }),
                x => x.AllConstraints.Should().BeEquivalentTo(new SymbolicConstraint[] { ObjectConstraint.NotNull, NumberConstraint.From(42), TestConstraint.First }));
    }
...
Tag(""End"", value);";
        ...
        validator.TagValues("End").Should().SatisfyRespectively(
            x => x.Should().HaveOnlyConstraints(ObjectConstraint.NotNull, NumberConstraint.From(42)),  // items with Null flow generated by implicty Finally block that has items?.Dispose()
            x => x.Should().HaveOnlyConstraints(ObjectConstraint.NotNull, NumberConstraint.From(42)),  // items with NotNull flow
            x => x.Should().HaveOnlyConstraints(ObjectConstraint.NotNull, NumberConstraint.From(42), TestConstraint.First),
            x => x.Should().HaveOnlyConstraints(ObjectConstraint.NotNull, NumberConstraint.From(42), TestConstraint.First));
    }
