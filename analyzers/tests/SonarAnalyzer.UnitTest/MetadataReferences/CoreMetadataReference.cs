...
namespace SonarAnalyzer.UnitTest.MetadataReferences
{
    internal static class CoreMetadataReference
    {
        ...
        internal static MetadataReference MicrosoftExtensionsDependencyInjectionAbstractions { get; } = CreateReference(typeof(Microsoft.Extensions.DependencyInjection.IServiceCollection).Assembly.Location);
