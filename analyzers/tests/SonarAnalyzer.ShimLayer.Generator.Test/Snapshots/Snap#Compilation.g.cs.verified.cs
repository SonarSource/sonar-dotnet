...
public static partial class CompilationShimExtensions
{
    ...
    private static readonly Func<Compilation, ITypeSymbol, int, NullableAnnotation, IArrayTypeSymbol> CreateArrayTypeSymbolAccessor_Overload2 = AccessorFactory.CreateMethod<Func<Compilation, ITypeSymbol, int, NullableAnnotation, IArrayTypeSymbol>>(WrappedType, "CreateArrayTypeSymbol");
    private static readonly Func<Compilation, string, ITypeSymbol, ITypeSymbol, IMethodSymbol> CreateBuiltinOperatorAccessor = AccessorFactory.CreateMethod<Func<Compilation, string, ITypeSymbol, ITypeSymbol, IMethodSymbol>>(WrappedType, "CreateBuiltinOperator");
    private static readonly Func<Compilation, string, ITypeSymbol, ITypeSymbol, ITypeSymbol, IMethodSymbol> CreateBuiltinOperatorAccessor_Overload2 = AccessorFactory.CreateMethod<Func<Compilation, string, ITypeSymbol, ITypeSymbol, ITypeSymbol, IMethodSymbol>>(WrappedType, "CreateBuiltinOperator");
    private static readonly Func<Compilation, INamespaceSymbol, string, INamespaceSymbol> CreateErrorNamespaceSymbolAccessor = AccessorFactory.CreateMethod<Func<Compilation, INamespaceSymbol, string, INamespaceSymbol>>(WrappedType, "CreateErrorNamespaceSymbol");
    private static readonly Func<Compilation, bool, INamedTypeSymbol> CreateNativeIntegerTypeSymbolAccessor = AccessorFactory.CreateMethod<Func<Compilation, bool, INamedTypeSymbol>>(WrappedType, "CreateNativeIntegerTypeSymbol");
    private static readonly Func<Compilation, string, IPreprocessingSymbol> CreatePreprocessingSymbolAccessor = AccessorFactory.CreateMethod<Func<Compilation, string, IPreprocessingSymbol>>(WrappedType, "CreatePreprocessingSymbol");
    private static readonly Func<Compilation, INamedTypeSymbol, ImmutableArray<string>, ImmutableArray<Location>, INamedTypeSymbol> CreateTupleTypeSymbolAccessor = AccessorFactory.CreateMethod<Func<Compilation, INamedTypeSymbol, ImmutableArray<string>, ImmutableArray<Location>, INamedTypeSymbol>>(WrappedType, "CreateTupleTypeSymbol");
    ...
    private static readonly Func<Compilation, Diagnostic, ImmutableArray<AssemblyIdentity>> GetUnreferencedAssemblyIdentitiesAccessor = AccessorFactory.CreateMethod<Func<Compilation, Diagnostic, ImmutableArray<AssemblyIdentity>>>(WrappedType, "GetUnreferencedAssemblyIdentities");
    private static readonly Func<Compilation, CancellationToken, ImmutableArray<MetadataReference>> GetUsedAssemblyReferencesAccessor = AccessorFactory.CreateMethod<Func<Compilation, CancellationToken, ImmutableArray<MetadataReference>>>(WrappedType, "GetUsedAssemblyReferences");
    private static readonly Func<Compilation, ITypeSymbol, ITypeSymbol, bool> HasImplicitConversionAccessor = AccessorFactory.CreateMethod<Func<Compilation, ITypeSymbol, ITypeSymbol, bool>>(WrappedType, "HasImplicitConversion");
    private static readonly Func<Compilation, ISymbol, ISymbol, ITypeSymbol, bool> IsSymbolAccessibleWithinAccessor = AccessorFactory.CreateMethod<Func<Compilation, ISymbol, ISymbol, ITypeSymbol, bool>>(WrappedType, "IsSymbolAccessibleWithin");
    private static readonly Func<Compilation, RuntimeCapability, bool> SupportsRuntimeCapabilityAccessor = AccessorFactory.CreateMethod<Func<Compilation, RuntimeCapability, bool>>(WrappedType, "SupportsRuntimeCapability");
