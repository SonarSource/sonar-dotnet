...
internal readonly partial struct IDefaultCaseClauseOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(IDefaultCaseClauseOperationWrapper));
