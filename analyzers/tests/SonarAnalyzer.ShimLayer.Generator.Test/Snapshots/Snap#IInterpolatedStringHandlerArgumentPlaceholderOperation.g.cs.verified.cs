...
public readonly partial struct IInterpolatedStringHandlerArgumentPlaceholderOperationWrapper : IOperationWrapper
{
    ...
    static IInterpolatedStringHandlerArgumentPlaceholderOperationWrapper()
    {
        ...
        ArgumentIndexAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, Int32>(WrappedType, "ArgumentIndex");
        PlaceholderKindAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, InterpolatedStringArgumentPlaceholderKind>(WrappedType, "PlaceholderKind");
    ...
    private IInterpolatedStringHandlerArgumentPlaceholderOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, Int32> ArgumentIndexAccessor;
    public Int32 ArgumentIndex => (Int32)ArgumentIndexAccessor(this.instance);
    private static readonly Func<IOperation, InterpolatedStringArgumentPlaceholderKind> PlaceholderKindAccessor;
    public InterpolatedStringArgumentPlaceholderKind PlaceholderKind => (InterpolatedStringArgumentPlaceholderKind)PlaceholderKindAccessor(this.instance);
