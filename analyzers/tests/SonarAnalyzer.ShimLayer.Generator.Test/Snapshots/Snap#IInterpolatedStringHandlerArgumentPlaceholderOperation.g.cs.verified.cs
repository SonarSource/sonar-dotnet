...
public readonly struct IInterpolatedStringHandlerArgumentPlaceholderOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IInterpolatedStringHandlerArgumentPlaceholderOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IInterpolatedStringHandlerArgumentPlaceholderOperation");
    ...
    public bool Equals(IInterpolatedStringHandlerArgumentPlaceholderOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IInterpolatedStringHandlerArgumentPlaceholderOperationWrapper left, IInterpolatedStringHandlerArgumentPlaceholderOperationWrapper right) =>
    ...
    public static IInterpolatedStringHandlerArgumentPlaceholderOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IInterpolatedStringHandlerArgumentPlaceholderOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IInterpolatedStringHandlerArgumentPlaceholderOperation'");
        }
    }
