...
public readonly struct ICaseClauseOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ICaseClauseOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ICaseClauseOperation");
    ...
    public bool Equals(ICaseClauseOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ICaseClauseOperationWrapper left, ICaseClauseOperationWrapper right) =>
    ...
    public static ICaseClauseOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static ICaseClauseOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new ICaseClauseOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ICaseClauseOperation'");
        }
    }
