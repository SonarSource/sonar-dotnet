...
public readonly partial struct IVariableDeclaratorOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IVariableDeclaratorOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IVariableDeclaratorOperationWrapper));
    private readonly IOperation instance;

    private IVariableDeclaratorOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, ILocalSymbol> SymbolAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, ILocalSymbol>(WrappedType, "Symbol");
    public ILocalSymbol Symbol => (ILocalSymbol)SymbolAccessor(this.instance);
    ...
    private static readonly Func<IOperation, ImmutableArray<IOperation>> IgnoredArgumentsAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, ImmutableArray<IOperation>>(WrappedType, "IgnoredArguments");
    public ImmutableArray<IOperation> IgnoredArguments => (ImmutableArray<IOperation>)IgnoredArgumentsAccessor(this.instance);
