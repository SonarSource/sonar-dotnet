...
public readonly struct IAnonymousFunctionOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IAnonymousFunctionOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IAnonymousFunctionOperation");
    ...
    private IAnonymousFunctionOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IAnonymousFunctionOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IAnonymousFunctionOperationWrapper left, IAnonymousFunctionOperationWrapper right) =>
    ...
    public static IAnonymousFunctionOperationWrapper? FromOrDefault(IOperation instance) =>
    ...
    public static IAnonymousFunctionOperationWrapper From(IOperation instance)
    {
        ...
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IAnonymousFunctionOperation'");
        }
    }
