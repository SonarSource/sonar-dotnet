...
public readonly struct SubpatternSyntaxWrapper : IWrapper, IEquatable<SubpatternSyntaxWrapper>
{
    ...
    public bool Equals(SubpatternSyntaxWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(SubpatternSyntaxWrapper left, SubpatternSyntaxWrapper right) =>
