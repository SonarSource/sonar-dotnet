...
public readonly struct IDiscardOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IDiscardOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IDiscardOperation");
    ...
    private static readonly Func<IOperation, IDiscardSymbolWrapper> DiscardSymbolAccessor = AccessorFactory.CreateProperty<Func<IOperation, IDiscardSymbolWrapper>>(WrappedType, "DiscardSymbol");
    ...
    public bool Equals(IDiscardOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IDiscardOperationWrapper left, IDiscardOperationWrapper right) =>
    ...
    public IDiscardSymbolWrapper DiscardSymbol => DiscardSymbolAccessor(wrappedInstance);
    ...
    public static IDiscardOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IDiscardOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IDiscardOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IDiscardOperation'");
        }
    }
