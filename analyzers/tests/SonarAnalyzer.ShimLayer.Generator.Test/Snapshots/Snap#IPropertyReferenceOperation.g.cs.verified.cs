...
internal readonly partial struct IPropertyReferenceOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(IPropertyReferenceOperationWrapper));
        PropertyAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IPropertySymbol>(WrappedType, "Property");
    ...
    private IPropertyReferenceOperationWrapper(IOperation instance) =>
    ...
    public IPropertySymbol Property => (IPropertySymbol)PropertyAccessor(this.instance);
