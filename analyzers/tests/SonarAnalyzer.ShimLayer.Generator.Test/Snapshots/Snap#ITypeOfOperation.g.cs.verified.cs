...
public readonly struct ITypeOfOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ITypeOfOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ITypeOfOperation");
    ...
    private ITypeOfOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(ITypeOfOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ITypeOfOperationWrapper left, ITypeOfOperationWrapper right) =>
    ...
    public static ITypeOfOperationWrapper? FromOrDefault(IOperation instance) =>
    ...
    public static ITypeOfOperationWrapper From(IOperation instance)
    {
        ...
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ITypeOfOperation'");
        }
    }
