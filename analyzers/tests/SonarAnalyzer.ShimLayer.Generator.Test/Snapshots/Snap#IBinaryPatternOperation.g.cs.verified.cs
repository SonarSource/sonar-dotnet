...
internal readonly partial struct IBinaryPatternOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(IBinaryPatternOperationWrapper));
        OperatorKindAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, BinaryOperatorKind>(WrappedType, "OperatorKind");
        LeftPatternAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "LeftPattern");
        RightPatternAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "RightPattern");
    ...
    public static IBinaryPatternOperationWrapper From(IOperation operation)
    {
