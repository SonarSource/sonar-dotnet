...
public readonly struct IBinaryPatternOperationWrapper : IOperationWrapper
{
    ...
    public static IBinaryPatternOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IBinaryPatternOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IBinaryPatternOperation'");
        }
    }
