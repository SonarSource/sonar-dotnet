...
public readonly struct ILocalReferenceOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ILocalReferenceOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ILocalReferenceOperation");
    ...
    private static readonly Func<IOperation, ILocalSymbol> LocalAccessor = AccessorFactory.CreateProperty<Func<IOperation, ILocalSymbol>>(WrappedType, "Local");
    ...
    private ILocalReferenceOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(ILocalReferenceOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ILocalReferenceOperationWrapper left, ILocalReferenceOperationWrapper right) =>
    ...
    public static ILocalReferenceOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new ILocalReferenceOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ILocalReferenceOperation'");
        }
    }
