...
public readonly partial struct ILocalReferenceOperationWrapper : IOperationWrapper
{
    ...
    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(ILocalReferenceOperationWrapper));
    ...
    private static readonly Func<IOperation, ILocalSymbol> LocalAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, ILocalSymbol>(WrappedType, "Local");
