...
public readonly struct IPropertyInitializerOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IPropertyInitializerOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IPropertyInitializerOperation");
    ...
    private static readonly Func<IOperation, ImmutableArray<IPropertySymbol>> InitializedPropertiesAccessor = AccessorFactory.CreateProperty<Func<IOperation, ImmutableArray<IPropertySymbol>>>(WrappedType, "InitializedProperties");
    ...
    public bool Equals(IPropertyInitializerOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IPropertyInitializerOperationWrapper left, IPropertyInitializerOperationWrapper right) =>
    ...
    public static IPropertyInitializerOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IPropertyInitializerOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IPropertyInitializerOperation'");
        }
    }
