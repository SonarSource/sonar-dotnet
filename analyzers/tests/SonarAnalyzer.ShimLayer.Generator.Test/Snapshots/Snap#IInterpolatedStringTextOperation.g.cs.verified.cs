...
public readonly struct IInterpolatedStringTextOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IInterpolatedStringTextOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IInterpolatedStringTextOperation");
    ...
    private static readonly Func<IOperation, IOperation> TextAccessor = AccessorFactory.CreateProperty<Func<IOperation, IOperation>>(WrappedType, "Text");
    ...
    private IInterpolatedStringTextOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IInterpolatedStringTextOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IInterpolatedStringTextOperationWrapper left, IInterpolatedStringTextOperationWrapper right) =>
    ...
    public static IInterpolatedStringTextOperationWrapper From(IOperation instance)
    {
        ...
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IInterpolatedStringTextOperation'");
        }
    }
