...
internal readonly partial struct IInterpolatedStringTextOperationWrapper : IOperationWrapper
{
    ...
    static IInterpolatedStringTextOperationWrapper()
    {
        ...
        TextAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "Text");
    ...
    private IInterpolatedStringTextOperationWrapper(IOperation instance) =>
    ...
    public IOperation Text => TextAccessor(this.instance);
