...
public readonly struct VariableDesignationSyntaxWrapper : IWrapper, IEquatable<VariableDesignationSyntaxWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.CSharp.Syntax.VariableDesignationSyntax");
    ...
    public bool Equals(VariableDesignationSyntaxWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(VariableDesignationSyntaxWrapper left, VariableDesignationSyntaxWrapper right) =>
    ...
    public static explicit operator VariableDesignationSyntaxWrapper(SyntaxNode instance) =>
        From(instance);

    public static implicit operator CSharpSyntaxNode(VariableDesignationSyntaxWrapper wrapper) =>
        wrapper.wrappedInstance;

    public static VariableDesignationSyntaxWrapper From(SyntaxNode instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new VariableDesignationSyntaxWrapper((CSharpSyntaxNode)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.CSharp.Syntax.VariableDesignationSyntax'");
        }
    }
