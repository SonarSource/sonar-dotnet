...
public readonly struct IEventAssignmentOperationWrapper : IOperationWrapper
{
    ...
    public static IEventAssignmentOperationWrapper FromOperation(IOperation instance) =>
        From(instance);
