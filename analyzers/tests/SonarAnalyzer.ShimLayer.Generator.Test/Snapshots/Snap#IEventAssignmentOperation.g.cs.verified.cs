...
public readonly struct IEventAssignmentOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IEventAssignmentOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IEventAssignmentOperation");
    ...
    public bool Equals(IEventAssignmentOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IEventAssignmentOperationWrapper left, IEventAssignmentOperationWrapper right) =>
    ...
    public bool Adds => AddsAccessor(wrappedInstance);
    ...
    public static IEventAssignmentOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IEventAssignmentOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IEventAssignmentOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IEventAssignmentOperation'");
        }
    }
