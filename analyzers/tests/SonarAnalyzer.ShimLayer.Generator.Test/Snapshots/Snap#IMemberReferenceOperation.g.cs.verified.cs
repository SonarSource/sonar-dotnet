...
public readonly struct IMemberReferenceOperationWrapper : IOperationWrapper
{
    ...
    public static IMemberReferenceOperationWrapper FromOperation(IOperation instance) =>
        From(instance);
