...
public readonly struct ITypeParameterObjectCreationOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ITypeParameterObjectCreationOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ITypeParameterObjectCreationOperation");
    ...
    private ITypeParameterObjectCreationOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(ITypeParameterObjectCreationOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ITypeParameterObjectCreationOperationWrapper left, ITypeParameterObjectCreationOperationWrapper right) =>
    ...
    public static ITypeParameterObjectCreationOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new ITypeParameterObjectCreationOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ITypeParameterObjectCreationOperation'");
        }
    }
