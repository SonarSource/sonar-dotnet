...
public readonly partial struct IInterpolatedStringAdditionOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IInterpolatedStringAdditionOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IInterpolatedStringAdditionOperationWrapper));
    ...
    private static readonly Func<IOperation, IOperation> LeftAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "Left");
    public IOperation Left => LeftAccessor(this.instance);
    private static readonly Func<IOperation, IOperation> RightAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "Right");
