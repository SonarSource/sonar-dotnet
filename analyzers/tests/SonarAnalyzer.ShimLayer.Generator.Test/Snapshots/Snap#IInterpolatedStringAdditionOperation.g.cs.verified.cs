...
public readonly struct IInterpolatedStringAdditionOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IInterpolatedStringAdditionOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IInterpolatedStringAdditionOperation");
    ...
    private static readonly Func<IOperation, IOperation> LeftAccessor = AccessorFactory.CreateProperty<Func<IOperation, IOperation>>(WrappedType, "Left");
    ...
    public bool Equals(IInterpolatedStringAdditionOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IInterpolatedStringAdditionOperationWrapper left, IInterpolatedStringAdditionOperationWrapper right) =>
    ...
    public static IInterpolatedStringAdditionOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IInterpolatedStringAdditionOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IInterpolatedStringAdditionOperation'");
        }
    }
