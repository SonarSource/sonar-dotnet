...
public readonly struct ExtensionBlockDeclarationSyntaxWrapper : IWrapper, IEquatable<ExtensionBlockDeclarationSyntaxWrapper>
{
    ...
    private static readonly Func<TypeDeclarationSyntax, AttributeListSyntax[], ExtensionBlockDeclarationSyntaxWrapper> AddAttributeListsAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, AttributeListSyntax[], ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "AddAttributeLists");
    ...
    private static readonly Func<TypeDeclarationSyntax, TypeParameterConstraintClauseSyntax[], ExtensionBlockDeclarationSyntaxWrapper> AddConstraintClausesAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, TypeParameterConstraintClauseSyntax[], ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "AddConstraintClauses");
    private static readonly Func<TypeDeclarationSyntax, MemberDeclarationSyntax[], ExtensionBlockDeclarationSyntaxWrapper> AddMembersAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, MemberDeclarationSyntax[], ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "AddMembers");
    private static readonly Func<TypeDeclarationSyntax, SyntaxToken[], ExtensionBlockDeclarationSyntaxWrapper> AddModifiersAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, SyntaxToken[], ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "AddModifiers");
    ...
    private static readonly Func<TypeDeclarationSyntax, SyntaxToken, ExtensionBlockDeclarationSyntaxWrapper> WithCloseBraceTokenAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, SyntaxToken, ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "WithCloseBraceToken");
    private static readonly Func<TypeDeclarationSyntax, SyntaxList<TypeParameterConstraintClauseSyntax>, ExtensionBlockDeclarationSyntaxWrapper> WithConstraintClausesAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, SyntaxList<TypeParameterConstraintClauseSyntax>, ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "WithConstraintClauses");
    ...
    private static readonly Func<TypeDeclarationSyntax, SyntaxToken, ExtensionBlockDeclarationSyntaxWrapper> WithKeywordAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, SyntaxToken, ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "WithKeyword");
    private static readonly Func<TypeDeclarationSyntax, SyntaxList<MemberDeclarationSyntax>, ExtensionBlockDeclarationSyntaxWrapper> WithMembersAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, SyntaxList<MemberDeclarationSyntax>, ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "WithMembers");
    private static readonly Func<TypeDeclarationSyntax, SyntaxTokenList, ExtensionBlockDeclarationSyntaxWrapper> WithModifiersAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, SyntaxTokenList, ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "WithModifiers");
    private static readonly Func<TypeDeclarationSyntax, SyntaxToken, ExtensionBlockDeclarationSyntaxWrapper> WithOpenBraceTokenAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, SyntaxToken, ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "WithOpenBraceToken");
    private static readonly Func<TypeDeclarationSyntax, ParameterListSyntax, ExtensionBlockDeclarationSyntaxWrapper> WithParameterListAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, ParameterListSyntax, ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "WithParameterList");
    private static readonly Func<TypeDeclarationSyntax, SyntaxToken, ExtensionBlockDeclarationSyntaxWrapper> WithSemicolonTokenAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, SyntaxToken, ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "WithSemicolonToken");
    private static readonly Func<TypeDeclarationSyntax, TypeParameterListSyntax, ExtensionBlockDeclarationSyntaxWrapper> WithTypeParameterListAccessor = AccessorFactory.CreateMethod<Func<TypeDeclarationSyntax, TypeParameterListSyntax, ExtensionBlockDeclarationSyntaxWrapper>>(WrappedType, "WithTypeParameterList");
    ...
    public ExtensionBlockDeclarationSyntaxWrapper WithCloseBraceToken(SyntaxToken closeBraceToken) => WithCloseBraceTokenAccessor(wrappedInstance, closeBraceToken);
    public ExtensionBlockDeclarationSyntaxWrapper WithConstraintClauses(SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses) => WithConstraintClausesAccessor(wrappedInstance, constraintClauses);
    public TypeDeclarationSyntax WithIdentifier(SyntaxToken identifier) => WithIdentifierAccessor(wrappedInstance, identifier);
    public ExtensionBlockDeclarationSyntaxWrapper WithKeyword(SyntaxToken keyword) => WithKeywordAccessor(wrappedInstance, keyword);
    public ExtensionBlockDeclarationSyntaxWrapper WithMembers(SyntaxList<MemberDeclarationSyntax> members) => WithMembersAccessor(wrappedInstance, members);
    public ExtensionBlockDeclarationSyntaxWrapper WithModifiers(SyntaxTokenList modifiers) => WithModifiersAccessor(wrappedInstance, modifiers);
    public ExtensionBlockDeclarationSyntaxWrapper WithOpenBraceToken(SyntaxToken openBraceToken) => WithOpenBraceTokenAccessor(wrappedInstance, openBraceToken);
    public ExtensionBlockDeclarationSyntaxWrapper WithParameterList(ParameterListSyntax parameterList) => WithParameterListAccessor(wrappedInstance, parameterList);
    public ExtensionBlockDeclarationSyntaxWrapper WithSemicolonToken(SyntaxToken semicolonToken) => WithSemicolonTokenAccessor(wrappedInstance, semicolonToken);
    public ExtensionBlockDeclarationSyntaxWrapper WithTypeParameterList(TypeParameterListSyntax typeParameterList) => WithTypeParameterListAccessor(wrappedInstance, typeParameterList);
