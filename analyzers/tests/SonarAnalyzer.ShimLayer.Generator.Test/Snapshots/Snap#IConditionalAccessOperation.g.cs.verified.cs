...
public readonly struct IConditionalAccessOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IConditionalAccessOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IConditionalAccessOperation");
    ...
    private static readonly Func<IOperation, IOperation> OperationAccessor = AccessorFactory.CreateProperty<Func<IOperation, IOperation>>(WrappedType, "Operation");
    ...
    private static readonly Func<IOperation, IOperation> WhenNotNullAccessor = AccessorFactory.CreateProperty<Func<IOperation, IOperation>>(WrappedType, "WhenNotNull");
    ...
    private IConditionalAccessOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IConditionalAccessOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IConditionalAccessOperationWrapper left, IConditionalAccessOperationWrapper right) =>
    ...
    public static IConditionalAccessOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IConditionalAccessOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IConditionalAccessOperation'");
        }
    }
