...
public readonly partial struct IFlowCaptureReferenceOperationWrapper : IOperationWrapper
{
    ...
    static IFlowCaptureReferenceOperationWrapper()
    {
        ...
        IdAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, CaptureId>(WrappedType, "Id");
        IsInitializationAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, Boolean>(WrappedType, "IsInitialization");
    ...
    private static readonly Func<IOperation, CaptureId> IdAccessor;
    public CaptureId Id => (CaptureId)IdAccessor(this.instance);
    private static readonly Func<IOperation, Boolean> IsInitializationAccessor;
