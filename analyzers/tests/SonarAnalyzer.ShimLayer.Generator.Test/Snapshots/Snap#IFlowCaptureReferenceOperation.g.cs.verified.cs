...
public readonly partial struct IFlowCaptureReferenceOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.FlowAnalysis.IFlowCaptureReferenceOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IFlowCaptureReferenceOperationWrapper));
    private readonly IOperation instance;

    private IFlowCaptureReferenceOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, CaptureId> IdAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, CaptureId>(WrappedType, "Id");
    public CaptureId Id => (CaptureId)IdAccessor(this.instance);
    private static readonly Func<IOperation, Boolean> IsInitializationAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, Boolean>(WrappedType, "IsInitialization");
    public Boolean IsInitialization => (Boolean)IsInitializationAccessor(this.instance);
