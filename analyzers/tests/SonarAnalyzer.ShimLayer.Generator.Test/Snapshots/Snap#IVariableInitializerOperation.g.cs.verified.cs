...
public readonly struct IVariableInitializerOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IVariableInitializerOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IVariableInitializerOperation");
    ...
    private IVariableInitializerOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IVariableInitializerOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IVariableInitializerOperationWrapper left, IVariableInitializerOperationWrapper right) =>
    ...
    public static IVariableInitializerOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IVariableInitializerOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IVariableInitializerOperation'");
        }
    }
