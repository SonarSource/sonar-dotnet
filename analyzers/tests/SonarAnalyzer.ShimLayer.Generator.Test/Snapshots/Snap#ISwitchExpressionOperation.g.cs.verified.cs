...
public readonly partial struct ISwitchExpressionOperationWrapper : IOperationWrapper
{
    ...
    static ISwitchExpressionOperationWrapper()
    {
        ...
        IsExhaustiveAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, Boolean>(WrappedType, "IsExhaustive");
    ...
    private ISwitchExpressionOperationWrapper(IOperation instance) =>
    ...
    public ImmutableArray<IOperation> Arms => ArmsAccessor(this.instance);
    private static readonly Func<IOperation, Boolean> IsExhaustiveAccessor;
    public Boolean IsExhaustive => (Boolean)IsExhaustiveAccessor(this.instance);
