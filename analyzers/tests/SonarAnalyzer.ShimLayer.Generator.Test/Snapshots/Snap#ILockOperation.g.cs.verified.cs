...
public readonly struct ILockOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ILockOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ILockOperation");
    ...
    private static readonly Func<IOperation, IOperation> LockedValueAccessor = AccessorFactory.CreateProperty<Func<IOperation, IOperation>>(WrappedType, "LockedValue");
    ...
    private ILockOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(ILockOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ILockOperationWrapper left, ILockOperationWrapper right) =>
    ...
    public IOperation LockedValue => LockedValueAccessor(wrappedInstance);
    ...
    public static ILockOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new ILockOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ILockOperation'");
        }
    }
