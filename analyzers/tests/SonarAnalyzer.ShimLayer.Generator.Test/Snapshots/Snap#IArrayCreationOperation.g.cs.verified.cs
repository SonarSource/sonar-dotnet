...
public readonly partial struct IArrayCreationOperationWrapper : IOperationWrapper
{
    ...
    private IArrayCreationOperationWrapper(IOperation wrappedInstance) =>
    ...
    public static IArrayCreationOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    [Obsolete("Use From instead")]
    public static IArrayCreationOperationWrapper FromOperation(IOperation instance) =>
        From(instance);

    public static IArrayCreationOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IArrayCreationOperationWrapper((IOperation)instance);
        }
        else
        {
