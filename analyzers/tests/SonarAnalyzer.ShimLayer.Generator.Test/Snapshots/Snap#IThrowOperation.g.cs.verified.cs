...
public readonly partial struct IThrowOperationWrapper : IOperationWrapper
{
    ...
    private static readonly Func<IOperation, IOperation> ExceptionAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "Exception");
    ...
    public static IThrowOperationWrapper From(IOperation operation)
    {
