...
public readonly struct IThrowOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IThrowOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IThrowOperation");
    ...
    private static readonly Func<IOperation, IOperation> ExceptionAccessor = AccessorFactory.CreateProperty<Func<IOperation, IOperation>>(WrappedType, "Exception");
    ...
    private IThrowOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IThrowOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IThrowOperationWrapper left, IThrowOperationWrapper right) =>
    ...
    public IOperation Exception => ExceptionAccessor(wrappedInstance);
    ...
    public static IThrowOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IThrowOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IThrowOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IThrowOperation'");
        }
    }
