...
public readonly struct IDeconstructionAssignmentOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IDeconstructionAssignmentOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IDeconstructionAssignmentOperation");
    ...
    public bool Equals(IDeconstructionAssignmentOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IDeconstructionAssignmentOperationWrapper left, IDeconstructionAssignmentOperationWrapper right) =>
    ...
    public static IDeconstructionAssignmentOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IDeconstructionAssignmentOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IDeconstructionAssignmentOperation'");
        }
    }
