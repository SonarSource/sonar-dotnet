...
public readonly struct IDeconstructionAssignmentOperationWrapper : IOperationWrapper
{
    ...
    public static IDeconstructionAssignmentOperationWrapper FromOperation(IOperation instance) =>
        From(instance);
