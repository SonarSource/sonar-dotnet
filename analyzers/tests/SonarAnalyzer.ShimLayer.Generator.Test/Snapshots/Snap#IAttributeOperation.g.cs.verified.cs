...
public readonly partial struct IAttributeOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IAttributeOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IAttributeOperationWrapper));
    private readonly IOperation instance;

    private IAttributeOperationWrapper(IOperation instance) =>
    ...
    public static IAttributeOperationWrapper From(IOperation operation)
    {
        ...
        {
            return new IAttributeOperationWrapper(operation);
        }
        else
        {
