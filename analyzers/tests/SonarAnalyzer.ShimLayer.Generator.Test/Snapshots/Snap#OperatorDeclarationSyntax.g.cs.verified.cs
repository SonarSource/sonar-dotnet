...
public static partial class OperatorDeclarationSyntaxShimExtensions
{
    ...
    private static readonly Func<OperatorDeclarationSyntax, Int32, Boolean> ContainsDirectiveAccessor = AccessorFactory.CreateMethod<Func<OperatorDeclarationSyntax, Int32, Boolean>>(WrappedType, "ContainsDirective");
    private static readonly Func<OperatorDeclarationSyntax, SyntaxNode, Boolean> IsIncrementallyIdenticalToAccessor = AccessorFactory.CreateMethod<Func<OperatorDeclarationSyntax, SyntaxNode, Boolean>>(WrappedType, "IsIncrementallyIdenticalTo");
