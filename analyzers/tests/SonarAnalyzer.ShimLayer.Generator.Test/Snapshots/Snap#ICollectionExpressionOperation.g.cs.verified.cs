...
public readonly struct ICollectionExpressionOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ICollectionExpressionOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ICollectionExpressionOperation");
    ...
    private static readonly Func<IOperation, IMethodSymbol> ConstructMethodAccessor = AccessorFactory.CreateProperty<Func<IOperation, IMethodSymbol>>(WrappedType, "ConstructMethod");
    ...
    private ICollectionExpressionOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(ICollectionExpressionOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ICollectionExpressionOperationWrapper left, ICollectionExpressionOperationWrapper right) =>
    ...
    public static ICollectionExpressionOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new ICollectionExpressionOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ICollectionExpressionOperation'");
        }
    }
