...
public readonly struct ILiteralOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ILiteralOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ILiteralOperation");
    ...
    public bool Equals(ILiteralOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ILiteralOperationWrapper left, ILiteralOperationWrapper right) =>
    ...
    public static ILiteralOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static ILiteralOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new ILiteralOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ILiteralOperation'");
        }
    }
