...
public readonly struct IFieldInitializerOperationWrapper : IOperationWrapper
{
    ...
    private static readonly Func<IOperation, ImmutableArray<IFieldSymbol>> InitializedFieldsAccessor = AccessorFactory.CreateProperty<Func<IOperation, ImmutableArray<IFieldSymbol>>>(WrappedType, "InitializedFields");
