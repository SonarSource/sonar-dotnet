...
public readonly partial struct IFieldInitializerOperationWrapper : IOperationWrapper
{
    ...
    private static readonly Func<IOperation, ImmutableArray<IFieldSymbol>> InitializedFieldsAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, ImmutableArray<IFieldSymbol>>(WrappedType, "InitializedFields");
    ...
    public ImmutableArray<IFieldSymbol> InitializedFields => (ImmutableArray<IFieldSymbol>)InitializedFieldsAccessor(wrappedInstance);
