...
public readonly struct IIsTypeOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IIsTypeOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IIsTypeOperation");
    ...
    public bool Equals(IIsTypeOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IIsTypeOperationWrapper left, IIsTypeOperationWrapper right) =>
    ...
    public bool IsNegated => IsNegatedAccessor(wrappedInstance);
    ...
    public static IIsTypeOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IIsTypeOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IIsTypeOperation'");
        }
    }
