...
public readonly partial struct IConstantPatternOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IConstantPatternOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IConstantPatternOperationWrapper));
    ...
    private IConstantPatternOperationWrapper(IOperation wrappedInstance) =>
    ...
    public static IConstantPatternOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    [Obsolete("Use From instead")]
    public static IConstantPatternOperationWrapper FromOperation(IOperation instance) =>
        From(instance);

    public static IConstantPatternOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IConstantPatternOperationWrapper((IOperation)instance);
        }
        else
        {
