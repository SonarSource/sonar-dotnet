...
public readonly partial struct IObjectOrCollectionInitializerOperationWrapper : IOperationWrapper
{
    ...
    private IObjectOrCollectionInitializerOperationWrapper(IOperation instance) =>
    ...
    public ImmutableArray<IOperation> Initializers => (ImmutableArray<IOperation>)InitializersAccessor(this.instance);
