...
public static partial class SyntaxTreeShimExtensions
{
    ...
    private static readonly Func<SyntaxTree, ImmutableDictionary<string, ReportDiagnostic>> DiagnosticOptionsAccessor = AccessorFactory.CreateProperty<Func<SyntaxTree, ImmutableDictionary<string, ReportDiagnostic>>>(WrappedType, "DiagnosticOptions");

    private static readonly Func<SyntaxTree, ImmutableDictionary<string, ReportDiagnostic>, SyntaxTree> WithDiagnosticOptionsAccessor = AccessorFactory.CreateMethod<Func<SyntaxTree, ImmutableDictionary<string, ReportDiagnostic>, SyntaxTree>>(WrappedType, "WithDiagnosticOptions");
