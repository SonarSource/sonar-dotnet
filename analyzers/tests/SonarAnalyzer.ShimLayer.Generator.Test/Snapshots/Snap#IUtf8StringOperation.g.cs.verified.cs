...
public readonly struct IUtf8StringOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IUtf8StringOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IUtf8StringOperation");
    ...
    private static readonly Func<IOperation, string> ValueAccessor = AccessorFactory.CreateProperty<Func<IOperation, string>>(WrappedType, "Value");
    ...
    private IUtf8StringOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IUtf8StringOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IUtf8StringOperationWrapper left, IUtf8StringOperationWrapper right) =>
    ...
    public string Value => ValueAccessor(wrappedInstance);
    ...
    public static IUtf8StringOperationWrapper From(IOperation instance)
    {
        ...
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IUtf8StringOperation'");
        }
    }
