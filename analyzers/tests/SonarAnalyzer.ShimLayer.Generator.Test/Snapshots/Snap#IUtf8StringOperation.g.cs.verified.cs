...
public readonly partial struct IUtf8StringOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IUtf8StringOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IUtf8StringOperationWrapper));
    private readonly IOperation instance;

    private IUtf8StringOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, String> ValueAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, String>(WrappedType, "Value");
    public String Value => (String)ValueAccessor(this.instance);
