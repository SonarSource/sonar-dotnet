...
public readonly struct IUsingOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IUsingOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IUsingOperation");
    ...
    public bool Equals(IUsingOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IUsingOperationWrapper left, IUsingOperationWrapper right) =>
    ...
    public static IUsingOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IUsingOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IUsingOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IUsingOperation'");
        }
    }
