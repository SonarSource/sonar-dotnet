...
public readonly struct GeneratorTimingInfoWrapper
{
    ...
    public static GeneratorTimingInfoWrapper From(Object instance)
    {
        ...
        {
            return new GeneratorTimingInfoWrapper((Object)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.GeneratorTimingInfo'");
        }
    }
