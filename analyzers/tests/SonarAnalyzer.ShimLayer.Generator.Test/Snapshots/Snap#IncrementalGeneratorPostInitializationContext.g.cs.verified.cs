...
public readonly struct IncrementalGeneratorPostInitializationContextWrapper : IWrapper, IEquatable<IncrementalGeneratorPostInitializationContextWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.IncrementalGeneratorPostInitializationContext");
    ...
    private static readonly Action<Object> AddEmbeddedAttributeDefinitionAccessor = AccessorFactory.CreateMethod<Action<Object>>(WrappedType, "AddEmbeddedAttributeDefinition");
    ...
    private IncrementalGeneratorPostInitializationContextWrapper(Object wrappedInstance) =>
    ...
    public bool Equals(IncrementalGeneratorPostInitializationContextWrapper other) =>
    ...
    public static IncrementalGeneratorPostInitializationContextWrapper From(Object instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IncrementalGeneratorPostInitializationContextWrapper((Object)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.IncrementalGeneratorPostInitializationContext'");
        }
    }
