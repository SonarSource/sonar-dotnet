...
public readonly struct IReDimOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IReDimOperationWrapper>
{
    ...
    public bool Equals(IReDimOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IReDimOperationWrapper left, IReDimOperationWrapper right) =>
    ...
    public bool Preserve => PreserveAccessor(wrappedInstance);
