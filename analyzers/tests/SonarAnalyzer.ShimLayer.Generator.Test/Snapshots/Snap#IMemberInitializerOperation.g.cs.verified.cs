...
public readonly struct IMemberInitializerOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IMemberInitializerOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IMemberInitializerOperation");
    ...
    private static readonly Func<IOperation, IOperation> InitializedMemberAccessor = AccessorFactory.CreateProperty<Func<IOperation, IOperation>>(WrappedType, "InitializedMember");
    ...
    private IMemberInitializerOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IMemberInitializerOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IMemberInitializerOperationWrapper left, IMemberInitializerOperationWrapper right) =>
    ...
    public IOperation InitializedMember => InitializedMemberAccessor(wrappedInstance);
    ...
    public static IMemberInitializerOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IMemberInitializerOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IMemberInitializerOperation'");
        }
    }
