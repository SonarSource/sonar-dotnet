...
public readonly struct IEmptyOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IEmptyOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IEmptyOperation");
    ...
    private IEmptyOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IEmptyOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IEmptyOperationWrapper left, IEmptyOperationWrapper right) =>
    ...
    public static IEmptyOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IEmptyOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IEmptyOperation'");
        }
    }
