...
public readonly struct IObjectCreationOperationWrapper : IOperationWrapper
{
    ...
    public static IObjectCreationOperationWrapper FromOperation(IOperation instance) =>
        From(instance);
