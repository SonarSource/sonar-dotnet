...
public static partial class BasePropertyDeclarationSyntaxShimExtensions
{
    ...
    private static readonly Func<BasePropertyDeclarationSyntax, Int32, Boolean> ContainsDirectiveAccessor = AccessorFactory.CreateMethod<Func<BasePropertyDeclarationSyntax, Int32, Boolean>>(WrappedType, "ContainsDirective");
    private static readonly Func<BasePropertyDeclarationSyntax, SyntaxNode, Boolean> IsIncrementallyIdenticalToAccessor = AccessorFactory.CreateMethod<Func<BasePropertyDeclarationSyntax, SyntaxNode, Boolean>>(WrappedType, "IsIncrementallyIdenticalTo");
