...
public readonly struct IRangeOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IRangeOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IRangeOperation");
    ...
    private IRangeOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IRangeOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IRangeOperationWrapper left, IRangeOperationWrapper right) =>
    ...
    public static IRangeOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IRangeOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IRangeOperation'");
        }
    }
