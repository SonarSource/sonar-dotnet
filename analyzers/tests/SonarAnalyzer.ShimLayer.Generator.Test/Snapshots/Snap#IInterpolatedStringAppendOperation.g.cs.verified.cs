...
public readonly struct IInterpolatedStringAppendOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IInterpolatedStringAppendOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IInterpolatedStringAppendOperation");
    ...
    private IInterpolatedStringAppendOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IInterpolatedStringAppendOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IInterpolatedStringAppendOperationWrapper left, IInterpolatedStringAppendOperationWrapper right) =>
    ...
    public IOperation AppendCall => AppendCallAccessor(wrappedInstance);
    ...
    public static IInterpolatedStringAppendOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IInterpolatedStringAppendOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IInterpolatedStringAppendOperation'");
        }
    }
