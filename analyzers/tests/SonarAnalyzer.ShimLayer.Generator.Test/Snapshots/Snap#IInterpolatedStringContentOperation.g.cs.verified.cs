...
internal readonly partial struct IInterpolatedStringContentOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(IInterpolatedStringContentOperationWrapper));
