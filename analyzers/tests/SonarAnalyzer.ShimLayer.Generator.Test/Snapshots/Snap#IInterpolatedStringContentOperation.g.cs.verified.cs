...
public readonly struct IInterpolatedStringContentOperationWrapper : IOperationWrapper
{
    ...
    public static IInterpolatedStringContentOperationWrapper FromOperation(IOperation instance) =>
        From(instance);
