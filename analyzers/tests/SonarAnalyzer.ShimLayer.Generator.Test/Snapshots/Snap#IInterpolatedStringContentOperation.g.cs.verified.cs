...
public readonly struct IInterpolatedStringContentOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IInterpolatedStringContentOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IInterpolatedStringContentOperation");
    ...
    private IInterpolatedStringContentOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IInterpolatedStringContentOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IInterpolatedStringContentOperationWrapper left, IInterpolatedStringContentOperationWrapper right) =>
    ...
    public static IInterpolatedStringContentOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IInterpolatedStringContentOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IInterpolatedStringContentOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IInterpolatedStringContentOperation'");
        }
    }
