...
public readonly struct IDelegateCreationOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IDelegateCreationOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IDelegateCreationOperation");
    ...
    private IDelegateCreationOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IDelegateCreationOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IDelegateCreationOperationWrapper left, IDelegateCreationOperationWrapper right) =>
    ...
    public static IDelegateCreationOperationWrapper From(IOperation instance)
    {
        ...
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IDelegateCreationOperation'");
        }
    }
