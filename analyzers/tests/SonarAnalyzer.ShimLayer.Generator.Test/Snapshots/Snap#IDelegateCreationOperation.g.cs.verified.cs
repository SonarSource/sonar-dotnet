...
internal readonly partial struct IDelegateCreationOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(IDelegateCreationOperationWrapper));
