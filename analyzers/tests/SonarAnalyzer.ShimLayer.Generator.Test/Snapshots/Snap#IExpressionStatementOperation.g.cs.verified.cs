...
public readonly struct IExpressionStatementOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IExpressionStatementOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IExpressionStatementOperation");
    ...
    private IExpressionStatementOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IExpressionStatementOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IExpressionStatementOperationWrapper left, IExpressionStatementOperationWrapper right) =>
    ...
    public static IExpressionStatementOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IExpressionStatementOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IExpressionStatementOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IExpressionStatementOperation'");
        }
    }
