...
public readonly struct IExpressionStatementOperationWrapper : IOperationWrapper
{
    ...
    public static IExpressionStatementOperationWrapper FromOperation(IOperation instance) =>
        From(instance);
