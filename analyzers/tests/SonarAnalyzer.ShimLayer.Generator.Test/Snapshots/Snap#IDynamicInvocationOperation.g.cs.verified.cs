...
public readonly struct IDynamicInvocationOperationWrapper : IOperationWrapper
{
    ...
    public static IDynamicInvocationOperationWrapper FromOperation(IOperation instance) =>
        From(instance);
