...
public readonly struct IDynamicInvocationOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IDynamicInvocationOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IDynamicInvocationOperation");
    ...
    private IDynamicInvocationOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IDynamicInvocationOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IDynamicInvocationOperationWrapper left, IDynamicInvocationOperationWrapper right) =>
    ...
    public static IDynamicInvocationOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IDynamicInvocationOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IDynamicInvocationOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IDynamicInvocationOperation'");
        }
    }
