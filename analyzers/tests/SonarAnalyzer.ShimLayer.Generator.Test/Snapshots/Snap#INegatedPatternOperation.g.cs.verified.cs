...
public readonly struct INegatedPatternOperationWrapper : IOperationWrapper, IWrapper, IEquatable<INegatedPatternOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.INegatedPatternOperation");
    ...
    private INegatedPatternOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(INegatedPatternOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(INegatedPatternOperationWrapper left, INegatedPatternOperationWrapper right) =>
    ...
    public static INegatedPatternOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new INegatedPatternOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.INegatedPatternOperation'");
        }
    }
