...
public readonly struct IPropertySubpatternOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IPropertySubpatternOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IPropertySubpatternOperation");
    ...
    private static readonly Func<IOperation, IOperation> MemberAccessor = AccessorFactory.CreateProperty<Func<IOperation, IOperation>>(WrappedType, "Member");
    ...
    private IPropertySubpatternOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IPropertySubpatternOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IPropertySubpatternOperationWrapper left, IPropertySubpatternOperationWrapper right) =>
    ...
    public IOperation Member => MemberAccessor(wrappedInstance);
    ...
    public static IPropertySubpatternOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IPropertySubpatternOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IPropertySubpatternOperation'");
        }
    }
