...
public readonly partial struct IArrayElementReferenceOperationWrapper : IOperationWrapper
{
    ...
    static IArrayElementReferenceOperationWrapper()
    {
        ...
        ArrayReferenceAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "ArrayReference");
        IndicesAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, ImmutableArray<IOperation>>(WrappedType, "Indices");
    ...
    private IArrayElementReferenceOperationWrapper(IOperation instance) =>
    ...
    public IOperation ArrayReference => ArrayReferenceAccessor(this.instance);
    private static readonly Func<IOperation, ImmutableArray<IOperation>> IndicesAccessor;
    public ImmutableArray<IOperation> Indices => (ImmutableArray<IOperation>)IndicesAccessor(this.instance);
