...
public readonly struct IArrayElementReferenceOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IArrayElementReferenceOperationWrapper>
{
    ...
    private static readonly Func<IOperation, ImmutableArray<IOperation>> IndicesAccessor = AccessorFactory.CreateProperty<Func<IOperation, ImmutableArray<IOperation>>>(WrappedType, "Indices");
    ...
    public bool Equals(IArrayElementReferenceOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IArrayElementReferenceOperationWrapper left, IArrayElementReferenceOperationWrapper right) =>
    ...
    public ImmutableArray<IOperation> Indices => IndicesAccessor(wrappedInstance);
