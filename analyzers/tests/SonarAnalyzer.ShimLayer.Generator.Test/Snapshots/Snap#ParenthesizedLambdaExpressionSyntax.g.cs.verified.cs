...
public static partial class ParenthesizedLambdaExpressionSyntaxShimExtensions
{
    ...
    private static readonly Func<ParenthesizedLambdaExpressionSyntax, Int32, Boolean> ContainsDirectiveAccessor = AccessorFactory.CreateMethod<Func<ParenthesizedLambdaExpressionSyntax, Int32, Boolean>>(WrappedType, "ContainsDirective");
    private static readonly Func<ParenthesizedLambdaExpressionSyntax, SyntaxNode, Boolean> IsIncrementallyIdenticalToAccessor = AccessorFactory.CreateMethod<Func<ParenthesizedLambdaExpressionSyntax, SyntaxNode, Boolean>>(WrappedType, "IsIncrementallyIdenticalTo");
