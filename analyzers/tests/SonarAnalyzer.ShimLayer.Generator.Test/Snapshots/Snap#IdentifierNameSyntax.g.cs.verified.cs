...
public static partial class IdentifierNameSyntaxShimExtensions
{
    ...
    private static readonly Func<IdentifierNameSyntax, Int32, Boolean> ContainsDirectiveAccessor = AccessorFactory.CreateMethod<Func<IdentifierNameSyntax, Int32, Boolean>>(WrappedType, "ContainsDirective");
    private static readonly Func<IdentifierNameSyntax, SyntaxNode, Boolean> IsIncrementallyIdenticalToAccessor = AccessorFactory.CreateMethod<Func<IdentifierNameSyntax, SyntaxNode, Boolean>>(WrappedType, "IsIncrementallyIdenticalTo");
