...
public readonly partial struct IReDimClauseOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IReDimClauseOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IReDimClauseOperationWrapper));
    private readonly IOperation instance;

    private IReDimClauseOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, ImmutableArray<IOperation>> DimensionSizesAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, ImmutableArray<IOperation>>(WrappedType, "DimensionSizes");
    public ImmutableArray<IOperation> DimensionSizes => (ImmutableArray<IOperation>)DimensionSizesAccessor(this.instance);
    ...
    public static IReDimClauseOperationWrapper From(IOperation operation)
    {
