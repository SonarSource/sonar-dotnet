...
public readonly partial struct IBlockOperationWrapper : IOperationWrapper
{
    ...
    private IBlockOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, ImmutableArray<IOperation>> OperationsAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, ImmutableArray<IOperation>>(WrappedType, "Operations");
    public ImmutableArray<IOperation> Operations => (ImmutableArray<IOperation>)OperationsAccessor(this.instance);
    ...
    public static IBlockOperationWrapper From(IOperation operation)
    {
