...
public readonly struct IBlockOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IBlockOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IBlockOperation");
    ...
    private static readonly Func<IOperation, ImmutableArray<IOperation>> OperationsAccessor = AccessorFactory.CreateProperty<Func<IOperation, ImmutableArray<IOperation>>>(WrappedType, "Operations");
    ...
    private IBlockOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IBlockOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IBlockOperationWrapper left, IBlockOperationWrapper right) =>
    ...
    public static IBlockOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IBlockOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IBlockOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IBlockOperation'");
        }
    }
