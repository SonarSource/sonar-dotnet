...
internal readonly partial struct ICoalesceOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(ICoalesceOperationWrapper));
        ValueAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "Value");
        WhenNullAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "WhenNull");
    ...
    private ICoalesceOperationWrapper(IOperation instance) =>
    ...
    public IOperation WhenNull => WhenNullAccessor(this.instance);
