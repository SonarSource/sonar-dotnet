...
public readonly struct IInvalidOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IInvalidOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IInvalidOperation");
    ...
    private IInvalidOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IInvalidOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IInvalidOperationWrapper left, IInvalidOperationWrapper right) =>
    ...
    public static IInvalidOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IInvalidOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IInvalidOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IInvalidOperation'");
        }
    }
