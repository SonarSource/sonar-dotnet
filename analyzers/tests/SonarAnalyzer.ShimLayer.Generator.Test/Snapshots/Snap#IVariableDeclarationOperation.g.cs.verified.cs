...
public readonly partial struct IVariableDeclarationOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IVariableDeclarationOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IVariableDeclarationOperationWrapper));
    private readonly IOperation instance;

    private IVariableDeclarationOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, ImmutableArray<IOperation>> DeclaratorsAccessor = LightupHelpers.CreateOperationListPropertyAccessor<IOperation>(WrappedType, nameof(Declarators));
    public ImmutableArray<IOperation> Declarators => DeclaratorsAccessor(this.instance);
    ...
    public IVariableInitializerOperationWrapper Initializer => IVariableInitializerOperationWrapper.From(InitializerAccessor(this.instance));
    private static readonly Func<IOperation, ImmutableArray<IOperation>> IgnoredDimensionsAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, ImmutableArray<IOperation>>(WrappedType, "IgnoredDimensions");
    public ImmutableArray<IOperation> IgnoredDimensions => (ImmutableArray<IOperation>)IgnoredDimensionsAccessor(this.instance);
    ...
    public static IVariableDeclarationOperationWrapper From(IOperation operation)
    {
