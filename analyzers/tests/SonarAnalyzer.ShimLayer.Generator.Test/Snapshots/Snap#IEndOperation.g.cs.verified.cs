...
public readonly struct IEndOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IEndOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IEndOperation");
    ...
    private IEndOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IEndOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IEndOperationWrapper left, IEndOperationWrapper right) =>
    ...
    public static IEndOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IEndOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IEndOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IEndOperation'");
        }
    }
