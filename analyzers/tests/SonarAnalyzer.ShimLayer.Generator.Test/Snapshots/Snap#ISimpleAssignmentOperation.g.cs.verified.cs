...
public readonly struct ISimpleAssignmentOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ISimpleAssignmentOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ISimpleAssignmentOperation");
    ...
    public bool Equals(ISimpleAssignmentOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ISimpleAssignmentOperationWrapper left, ISimpleAssignmentOperationWrapper right) =>
    ...
    public static ISimpleAssignmentOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new ISimpleAssignmentOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ISimpleAssignmentOperation'");
        }
    }
