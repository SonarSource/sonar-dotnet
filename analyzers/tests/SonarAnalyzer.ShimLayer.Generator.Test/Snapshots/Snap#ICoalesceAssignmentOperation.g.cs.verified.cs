...
public readonly struct ICoalesceAssignmentOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ICoalesceAssignmentOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ICoalesceAssignmentOperation");
    ...
    private ICoalesceAssignmentOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(ICoalesceAssignmentOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ICoalesceAssignmentOperationWrapper left, ICoalesceAssignmentOperationWrapper right) =>
    ...
    public static ICoalesceAssignmentOperationWrapper? FromOrDefault(IOperation instance) =>
    ...
    public static ICoalesceAssignmentOperationWrapper From(IOperation instance)
    {
        ...
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ICoalesceAssignmentOperation'");
        }
    }
