...
public readonly struct IArrayInitializerOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IArrayInitializerOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IArrayInitializerOperation");
    ...
    private static readonly Func<IOperation, ImmutableArray<IOperation>> ElementValuesAccessor = AccessorFactory.CreateProperty<Func<IOperation, ImmutableArray<IOperation>>>(WrappedType, "ElementValues");
    ...
    private IArrayInitializerOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IArrayInitializerOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IArrayInitializerOperationWrapper left, IArrayInitializerOperationWrapper right) =>
    ...
    public ImmutableArray<IOperation> ElementValues => (ImmutableArray<IOperation>)ElementValuesAccessor(wrappedInstance);
    ...
    public static IArrayInitializerOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IArrayInitializerOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IArrayInitializerOperation'");
        }
    }
