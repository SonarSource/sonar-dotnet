...
internal readonly partial struct INameOfOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(INameOfOperationWrapper));
    ...
    private INameOfOperationWrapper(IOperation instance) =>
