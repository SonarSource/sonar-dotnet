...
internal readonly partial struct ISpreadOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(ISpreadOperationWrapper));
        OperandAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "Operand");
        ElementTypeAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, ITypeSymbol>(WrappedType, "ElementType");
    ...
    private static readonly Func<IOperation, ITypeSymbol> ElementTypeAccessor;
