...
public readonly struct ISpreadOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ISpreadOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ISpreadOperation");
    ...
    private static readonly Func<IOperation, CommonConversionWrapper> ElementConversionAccessor = AccessorFactory.CreateProperty<Func<IOperation, CommonConversionWrapper>>(WrappedType, "ElementConversion");
    ...
    private ISpreadOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(ISpreadOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ISpreadOperationWrapper left, ISpreadOperationWrapper right) =>
    ...
    public CommonConversionWrapper ElementConversion => ElementConversionAccessor(wrappedInstance);
    ...
    public static ISpreadOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static ISpreadOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new ISpreadOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ISpreadOperation'");
        }
    }
