...
public readonly struct IIsNullOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IIsNullOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.FlowAnalysis.IIsNullOperation");
    ...
    private IIsNullOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IIsNullOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IIsNullOperationWrapper left, IIsNullOperationWrapper right) =>
    ...
    public static IIsNullOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IIsNullOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IIsNullOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.FlowAnalysis.IIsNullOperation'");
        }
    }
