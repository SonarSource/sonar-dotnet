...
public readonly struct IAnonymousObjectCreationOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IAnonymousObjectCreationOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IAnonymousObjectCreationOperation");
    ...
    private IAnonymousObjectCreationOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IAnonymousObjectCreationOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IAnonymousObjectCreationOperationWrapper left, IAnonymousObjectCreationOperationWrapper right) =>
    ...
    public static IAnonymousObjectCreationOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IAnonymousObjectCreationOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IAnonymousObjectCreationOperation'");
        }
    }
