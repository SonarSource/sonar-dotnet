...
public readonly struct ITypePatternOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ITypePatternOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ITypePatternOperation");
    ...
    private ITypePatternOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(ITypePatternOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ITypePatternOperationWrapper left, ITypePatternOperationWrapper right) =>
    ...
    public static ITypePatternOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static ITypePatternOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new ITypePatternOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ITypePatternOperation'");
        }
    }
    ...
    public static implicit operator IPatternOperationWrapper(ITypePatternOperationWrapper up) => IPatternOperationWrapper.From(up.WrappedInstance);
    public static explicit operator ITypePatternOperationWrapper(IPatternOperationWrapper down) => ITypePatternOperationWrapper.From(down.WrappedInstance);
}