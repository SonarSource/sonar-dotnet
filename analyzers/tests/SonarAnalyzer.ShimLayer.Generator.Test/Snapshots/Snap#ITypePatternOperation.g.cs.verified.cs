...
public readonly partial struct ITypePatternOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.ITypePatternOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(ITypePatternOperationWrapper));
    private readonly IOperation instance;

    private ITypePatternOperationWrapper(IOperation instance) =>
    ...
    public static ITypePatternOperationWrapper From(IOperation operation)
    {
