...
internal readonly partial struct ITypePatternOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(ITypePatternOperationWrapper));
