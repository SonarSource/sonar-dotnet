...
public static partial class ConversionOperatorDeclarationSyntaxShimExtensions
{
    ...
    private static readonly Func<ConversionOperatorDeclarationSyntax, Int32, Boolean> ContainsDirectiveAccessor = AccessorFactory.CreateMethod<Func<ConversionOperatorDeclarationSyntax, Int32, Boolean>>(WrappedType, "ContainsDirective");
    private static readonly Func<ConversionOperatorDeclarationSyntax, SyntaxNode, Boolean> IsIncrementallyIdenticalToAccessor = AccessorFactory.CreateMethod<Func<ConversionOperatorDeclarationSyntax, SyntaxNode, Boolean>>(WrappedType, "IsIncrementallyIdenticalTo");
