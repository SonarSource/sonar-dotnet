...
public readonly struct IPatternOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IPatternOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IPatternOperation");
    ...
    private IPatternOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IPatternOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IPatternOperationWrapper left, IPatternOperationWrapper right) =>
    ...
    public static IPatternOperationWrapper? FromOrDefault(IOperation instance) =>
    ...
    public static IPatternOperationWrapper From(IOperation instance)
    {
        ...
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IPatternOperation'");
        }
    }
