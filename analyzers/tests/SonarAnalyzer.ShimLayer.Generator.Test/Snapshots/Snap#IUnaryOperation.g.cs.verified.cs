...
public readonly struct IUnaryOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IUnaryOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IUnaryOperation");
    ...
    private static readonly Func<IOperation, UnaryOperatorKind> OperatorKindAccessor = AccessorFactory.CreateProperty<Func<IOperation, UnaryOperatorKind>>(WrappedType, "OperatorKind");
    ...
    public bool Equals(IUnaryOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IUnaryOperationWrapper left, IUnaryOperationWrapper right) =>
    ...
    public static IUnaryOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IUnaryOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IUnaryOperation'");
        }
    }
