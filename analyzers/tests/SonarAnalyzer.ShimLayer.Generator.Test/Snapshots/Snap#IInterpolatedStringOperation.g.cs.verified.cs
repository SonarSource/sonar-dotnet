...
public readonly partial struct IInterpolatedStringOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IInterpolatedStringOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IInterpolatedStringOperationWrapper));
    private readonly IOperation instance;

    private IInterpolatedStringOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, ImmutableArray<IOperation>> PartsAccessor = LightupHelpers.CreateOperationListPropertyAccessor<IOperation>(WrappedType, nameof(Parts));
    public ImmutableArray<IOperation> Parts => PartsAccessor(this.instance);
