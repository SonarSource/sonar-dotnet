...
public readonly struct IInterpolatedStringOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IInterpolatedStringOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IInterpolatedStringOperation");
    ...
    public bool Equals(IInterpolatedStringOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IInterpolatedStringOperationWrapper left, IInterpolatedStringOperationWrapper right) =>
    ...
    public static IInterpolatedStringOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IInterpolatedStringOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IInterpolatedStringOperation'");
        }
    }
