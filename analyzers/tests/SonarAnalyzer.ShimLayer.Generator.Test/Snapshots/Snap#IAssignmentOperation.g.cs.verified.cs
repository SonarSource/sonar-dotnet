...
public readonly struct IAssignmentOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IAssignmentOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IAssignmentOperation");
    ...
    private IAssignmentOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IAssignmentOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IAssignmentOperationWrapper left, IAssignmentOperationWrapper right) =>
    ...
    public static IAssignmentOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IAssignmentOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IAssignmentOperation'");
        }
    }
