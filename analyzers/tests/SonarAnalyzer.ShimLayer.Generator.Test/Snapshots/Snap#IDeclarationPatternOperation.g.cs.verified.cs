...
public readonly struct IDeclarationPatternOperationWrapper : IOperationWrapper
{
    ...
    public static IDeclarationPatternOperationWrapper FromOperation(IOperation instance) =>
        From(instance);
