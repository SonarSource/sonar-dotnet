...
public readonly struct IAwaitOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IAwaitOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IAwaitOperation");
    ...
    private IAwaitOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IAwaitOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IAwaitOperationWrapper left, IAwaitOperationWrapper right) =>
    ...
    public static IAwaitOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IAwaitOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IAwaitOperation'");
        }
    }
