...
public readonly struct ITranslatedQueryOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ITranslatedQueryOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ITranslatedQueryOperation");
    ...
    public bool Equals(ITranslatedQueryOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ITranslatedQueryOperationWrapper left, ITranslatedQueryOperationWrapper right) =>
    ...
    public static ITranslatedQueryOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new ITranslatedQueryOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ITranslatedQueryOperation'");
        }
    }
