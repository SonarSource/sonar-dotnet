...
public readonly partial struct IVariableDeclarationGroupOperationWrapper : IOperationWrapper
{
    ...
    private IVariableDeclarationGroupOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, ImmutableArray<IOperation>> DeclarationsAccessor = LightupHelpers.CreateOperationListPropertyAccessor<IOperation>(WrappedType, nameof(Declarations));
    public ImmutableArray<IOperation> Declarations => DeclarationsAccessor(this.instance);
