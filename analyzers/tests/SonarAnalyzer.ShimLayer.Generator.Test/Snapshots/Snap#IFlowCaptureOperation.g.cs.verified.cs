...
public readonly partial struct IFlowCaptureOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.FlowAnalysis.IFlowCaptureOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IFlowCaptureOperationWrapper));
    private readonly IOperation instance;

    private IFlowCaptureOperationWrapper(IOperation instance) =>
    ...
    public static IFlowCaptureOperationWrapper From(IOperation operation)
    {
