...
public readonly struct IFlowCaptureOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IFlowCaptureOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.FlowAnalysis.IFlowCaptureOperation");
    ...
    private IFlowCaptureOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IFlowCaptureOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IFlowCaptureOperationWrapper left, IFlowCaptureOperationWrapper right) =>
    ...
    public static IFlowCaptureOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IFlowCaptureOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.FlowAnalysis.IFlowCaptureOperation'");
        }
    }
