...
public readonly struct ILabeledOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ILabeledOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ILabeledOperation");
    ...
    private ILabeledOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(ILabeledOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ILabeledOperationWrapper left, ILabeledOperationWrapper right) =>
    ...
    public static ILabeledOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static ILabeledOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new ILabeledOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ILabeledOperation'");
        }
    }
