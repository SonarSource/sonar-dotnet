...
public readonly struct IAddressOfOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IAddressOfOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IAddressOfOperation");
    ...
    private static readonly Func<IOperation, IOperation> ReferenceAccessor = AccessorFactory.CreateProperty<Func<IOperation, IOperation>>(WrappedType, "Reference");
    ...
    private IAddressOfOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IAddressOfOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IAddressOfOperationWrapper left, IAddressOfOperationWrapper right) =>
    ...
    public IOperation Reference => ReferenceAccessor(wrappedInstance);
    ...
    public static IAddressOfOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IAddressOfOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IAddressOfOperation'");
        }
    }
