...
public readonly partial struct IAddressOfOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IAddressOfOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IAddressOfOperationWrapper));
    ...
    private static readonly Func<IOperation, IOperation> ReferenceAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "Reference");
    ...
    public static IAddressOfOperationWrapper From(IOperation operation)
    {
