...
public readonly struct RecursivePatternSyntaxWrapper : IWrapper, IEquatable<RecursivePatternSyntaxWrapper>
{
    ...
    public bool Equals(RecursivePatternSyntaxWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(RecursivePatternSyntaxWrapper left, RecursivePatternSyntaxWrapper right) =>
