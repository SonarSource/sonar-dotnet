...
public readonly struct ICatchClauseOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ICatchClauseOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.ICatchClauseOperation");
    ...
    public bool Equals(ICatchClauseOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ICatchClauseOperationWrapper left, ICatchClauseOperationWrapper right) =>
    ...
    public static ICatchClauseOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new ICatchClauseOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.ICatchClauseOperation'");
        }
    }
