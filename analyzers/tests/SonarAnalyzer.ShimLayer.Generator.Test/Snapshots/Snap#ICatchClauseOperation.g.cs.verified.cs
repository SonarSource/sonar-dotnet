...
internal readonly partial struct ICatchClauseOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.ICatchClauseOperation";
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(ICatchClauseOperationWrapper));
        ExceptionDeclarationOrExpressionAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "ExceptionDeclarationOrExpression");
        ExceptionTypeAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, ITypeSymbol>(WrappedType, "ExceptionType");
    ...
    private ICatchClauseOperationWrapper(IOperation instance) =>
    ...
    public IOperation ExceptionDeclarationOrExpression => ExceptionDeclarationOrExpressionAccessor(this.instance);
    private static readonly Func<IOperation, ITypeSymbol> ExceptionTypeAccessor;
    public ITypeSymbol ExceptionType => (ITypeSymbol)ExceptionTypeAccessor(this.instance);
    ...
    public IOperation Filter => FilterAccessor(this.instance);
    ...
    public static ICatchClauseOperationWrapper From(IOperation operation)
    {
