...
public readonly partial struct IWithOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IWithOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IWithOperationWrapper));
    ...
    private static readonly Func<IOperation, IOperation> OperandAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "Operand");
    public IOperation Operand => OperandAccessor(this.instance);
    private static readonly Func<IOperation, IMethodSymbol> CloneMethodAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IMethodSymbol>(WrappedType, "CloneMethod");
