...
public readonly partial struct VarPatternSyntaxWrapper : ISyntaxWrapper<CSharpSyntaxNode>
{
    ...
    public VarPatternSyntaxWrapper Update(SyntaxToken varKeyword, CSharpSyntaxNode designation) => VarPatternSyntaxWrapper.From(UpdateAccessor(wrappedInstance, varKeyword, designation));
    public VarPatternSyntaxWrapper WithDesignation(CSharpSyntaxNode designation) => VarPatternSyntaxWrapper.From(WithDesignationAccessor(wrappedInstance, designation));
    ...
    public static implicit operator ExpressionOrPatternSyntaxWrapper(VarPatternSyntaxWrapper up) => ExpressionOrPatternSyntaxWrapper.From(up.WrappedInstance);
    public static explicit operator VarPatternSyntaxWrapper(ExpressionOrPatternSyntaxWrapper down) => VarPatternSyntaxWrapper.From(down.WrappedInstance);
