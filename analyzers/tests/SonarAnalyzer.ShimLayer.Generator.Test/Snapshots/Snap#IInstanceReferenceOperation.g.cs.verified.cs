...
internal readonly partial struct IInstanceReferenceOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(IInstanceReferenceOperationWrapper));
        ReferenceKindAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, InstanceReferenceKind>(WrappedType, "ReferenceKind");
    ...
    private static readonly Func<IOperation, InstanceReferenceKind> ReferenceKindAccessor;
