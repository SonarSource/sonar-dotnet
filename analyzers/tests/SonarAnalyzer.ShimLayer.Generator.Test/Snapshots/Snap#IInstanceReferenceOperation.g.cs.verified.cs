...
public readonly struct IInstanceReferenceOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IInstanceReferenceOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IInstanceReferenceOperation");
    ...
    public bool Equals(IInstanceReferenceOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IInstanceReferenceOperationWrapper left, IInstanceReferenceOperationWrapper right) =>
    ...
    public InstanceReferenceKind ReferenceKind => ReferenceKindAccessor(wrappedInstance);
    ...
    public static IInstanceReferenceOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IInstanceReferenceOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IInstanceReferenceOperation'");
        }
    }
