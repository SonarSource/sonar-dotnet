...
public readonly partial struct IInstanceReferenceOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IInstanceReferenceOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IInstanceReferenceOperationWrapper));
    private readonly IOperation instance;

    private IInstanceReferenceOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, InstanceReferenceKind> ReferenceKindAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, InstanceReferenceKind>(WrappedType, "ReferenceKind");
    public InstanceReferenceKind ReferenceKind => (InstanceReferenceKind)ReferenceKindAccessor(this.instance);
    ...
    public static IInstanceReferenceOperationWrapper From(IOperation operation)
    {
