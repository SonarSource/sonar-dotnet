...
public readonly struct IOmittedArgumentOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IOmittedArgumentOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IOmittedArgumentOperation");
    ...
    private IOmittedArgumentOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IOmittedArgumentOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IOmittedArgumentOperationWrapper left, IOmittedArgumentOperationWrapper right) =>
    ...
    public static IOmittedArgumentOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IOmittedArgumentOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IOmittedArgumentOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IOmittedArgumentOperation'");
        }
    }
