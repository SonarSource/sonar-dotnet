...
internal readonly partial struct IOmittedArgumentOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(IOmittedArgumentOperationWrapper));
