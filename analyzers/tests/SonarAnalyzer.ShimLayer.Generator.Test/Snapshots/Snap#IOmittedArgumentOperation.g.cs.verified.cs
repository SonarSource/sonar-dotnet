...
public readonly struct IOmittedArgumentOperationWrapper : IOperationWrapper
{
    ...
    public static IOmittedArgumentOperationWrapper FromOperation(IOperation instance) =>
        From(instance);
