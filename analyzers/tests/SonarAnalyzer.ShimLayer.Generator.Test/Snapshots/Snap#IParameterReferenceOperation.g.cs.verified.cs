...
public readonly struct IParameterReferenceOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IParameterReferenceOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IParameterReferenceOperation");
    ...
    private IParameterReferenceOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IParameterReferenceOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IParameterReferenceOperationWrapper left, IParameterReferenceOperationWrapper right) =>
    ...
    public static IParameterReferenceOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IParameterReferenceOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IParameterReferenceOperation'");
        }
    }
