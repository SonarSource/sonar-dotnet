...
public readonly struct IMethodBodyOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IMethodBodyOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IMethodBodyOperation");
    ...
    public bool Equals(IMethodBodyOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IMethodBodyOperationWrapper left, IMethodBodyOperationWrapper right) =>
    ...
    public static IMethodBodyOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IMethodBodyOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IMethodBodyOperation'");
        }
    }
