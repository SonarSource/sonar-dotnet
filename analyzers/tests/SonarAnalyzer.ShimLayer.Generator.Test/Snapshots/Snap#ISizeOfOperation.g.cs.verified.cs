...
public readonly struct ISizeOfOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ISizeOfOperationWrapper>
{
    ...
    private ISizeOfOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(ISizeOfOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ISizeOfOperationWrapper left, ISizeOfOperationWrapper right) =>
    ...
    public static ISizeOfOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new ISizeOfOperationWrapper((IOperation)instance);
        }
        else
        {
