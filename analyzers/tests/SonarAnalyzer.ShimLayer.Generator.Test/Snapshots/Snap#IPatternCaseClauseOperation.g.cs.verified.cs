...
public readonly struct IPatternCaseClauseOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IPatternCaseClauseOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IPatternCaseClauseOperation");
    ...
    public bool Equals(IPatternCaseClauseOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IPatternCaseClauseOperationWrapper left, IPatternCaseClauseOperationWrapper right) =>
    ...
    public static IPatternCaseClauseOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IPatternCaseClauseOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IPatternCaseClauseOperation'");
        }
    }
