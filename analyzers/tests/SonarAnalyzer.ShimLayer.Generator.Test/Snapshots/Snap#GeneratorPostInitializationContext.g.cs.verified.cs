...
public readonly struct GeneratorPostInitializationContextWrapper : IWrapper, IEquatable<GeneratorPostInitializationContextWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.GeneratorPostInitializationContext");
    ...
    private GeneratorPostInitializationContextWrapper(Object wrappedInstance) =>
    ...
    public bool Equals(GeneratorPostInitializationContextWrapper other) =>
    ...
    public static GeneratorPostInitializationContextWrapper From(Object instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new GeneratorPostInitializationContextWrapper((Object)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.GeneratorPostInitializationContext'");
        }
    }
