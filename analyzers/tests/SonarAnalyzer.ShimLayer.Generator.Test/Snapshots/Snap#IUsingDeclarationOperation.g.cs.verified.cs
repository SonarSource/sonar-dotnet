...
public readonly partial struct IUsingDeclarationOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IUsingDeclarationOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IUsingDeclarationOperationWrapper));
    private readonly IOperation instance;

    private IUsingDeclarationOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, IOperation> DeclarationGroupAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "DeclarationGroup");
    public IVariableDeclarationGroupOperationWrapper DeclarationGroup => IVariableDeclarationGroupOperationWrapper.From(DeclarationGroupAccessor(this.instance));
    ...
    public static IUsingDeclarationOperationWrapper From(IOperation operation)
    {
