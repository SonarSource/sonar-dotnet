...
public readonly struct IIncrementalGeneratorWrapper
{
    ...
    public static IIncrementalGeneratorWrapper From(object instance)
    {
        ...
        {
            return new IIncrementalGeneratorWrapper((Object)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.IIncrementalGenerator'");
        }
    }
