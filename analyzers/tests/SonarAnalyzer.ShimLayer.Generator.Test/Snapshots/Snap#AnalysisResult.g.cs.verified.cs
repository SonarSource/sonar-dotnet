...
public static partial class AnalysisResultShimExtensions
{
    ...
    private static readonly Func<AnalysisResult, ImmutableDictionary<AdditionalText, ImmutableDictionary<DiagnosticAnalyzer, ImmutableArray<Diagnostic>>>> AdditionalFileDiagnosticsAccessor = AccessorFactory.CreateProperty<Func<AnalysisResult, ImmutableDictionary<AdditionalText, ImmutableDictionary<DiagnosticAnalyzer, ImmutableArray<Diagnostic>>>>>(WrappedType, "AdditionalFileDiagnostics");
