...
public readonly struct ITryOperationWrapper : IOperationWrapper, IWrapper, IEquatable<ITryOperationWrapper>
{
    ...
    public bool Equals(ITryOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(ITryOperationWrapper left, ITryOperationWrapper right) =>
