...
public readonly struct IIsPatternOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IIsPatternOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IIsPatternOperation");
    ...
    public bool Equals(IIsPatternOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IIsPatternOperationWrapper left, IIsPatternOperationWrapper right) =>
    ...
    public static IIsPatternOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IIsPatternOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IIsPatternOperation'");
        }
    }
