...
public readonly struct IRangeCaseClauseOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IRangeCaseClauseOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IRangeCaseClauseOperation");
    ...
    public bool Equals(IRangeCaseClauseOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IRangeCaseClauseOperationWrapper left, IRangeCaseClauseOperationWrapper right) =>
    ...
    public static IRangeCaseClauseOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IRangeCaseClauseOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IRangeCaseClauseOperation'");
        }
    }
