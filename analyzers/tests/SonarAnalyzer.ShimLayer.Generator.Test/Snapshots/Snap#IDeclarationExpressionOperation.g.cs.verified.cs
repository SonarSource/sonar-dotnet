...
public readonly struct IDeclarationExpressionOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IDeclarationExpressionOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IDeclarationExpressionOperation");
    ...
    private IDeclarationExpressionOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IDeclarationExpressionOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IDeclarationExpressionOperationWrapper left, IDeclarationExpressionOperationWrapper right) =>
    ...
    public static IDeclarationExpressionOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IDeclarationExpressionOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IDeclarationExpressionOperation'");
        }
    }
