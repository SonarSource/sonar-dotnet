...
internal readonly partial struct IDeclarationExpressionOperationWrapper : IOperationWrapper
{
    ...
    {
        WrappedType = TypeRegister.LatestType(typeof(IDeclarationExpressionOperationWrapper));
