...
public readonly struct IParenthesizedOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IParenthesizedOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IParenthesizedOperation");
    ...
    private IParenthesizedOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IParenthesizedOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IParenthesizedOperationWrapper left, IParenthesizedOperationWrapper right) =>
    ...
    public static IParenthesizedOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IParenthesizedOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IParenthesizedOperation'");
        }
    }
