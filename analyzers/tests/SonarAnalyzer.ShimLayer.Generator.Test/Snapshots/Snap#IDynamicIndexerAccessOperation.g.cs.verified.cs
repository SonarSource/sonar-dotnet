...
public readonly struct IDynamicIndexerAccessOperationWrapper : IOperationWrapper
{
    ...
    public static IDynamicIndexerAccessOperationWrapper FromOperation(IOperation instance) =>
        From(instance);
