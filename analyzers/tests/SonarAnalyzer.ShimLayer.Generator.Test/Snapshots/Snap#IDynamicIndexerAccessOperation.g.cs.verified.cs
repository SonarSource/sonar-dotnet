...
public readonly struct IDynamicIndexerAccessOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IDynamicIndexerAccessOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IDynamicIndexerAccessOperation");
    ...
    private IDynamicIndexerAccessOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IDynamicIndexerAccessOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IDynamicIndexerAccessOperationWrapper left, IDynamicIndexerAccessOperationWrapper right) =>
    ...
    public static IDynamicIndexerAccessOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IDynamicIndexerAccessOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IDynamicIndexerAccessOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IDynamicIndexerAccessOperation'");
        }
    }
