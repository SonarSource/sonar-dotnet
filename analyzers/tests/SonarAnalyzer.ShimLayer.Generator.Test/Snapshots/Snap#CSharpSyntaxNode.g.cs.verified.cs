...
public static partial class CSharpSyntaxNodeShimExtensions
{
    private static readonly Type WrappedType = typeof(CSharpSyntaxNode);
    ...
    extension(CSharpSyntaxNode wrappedInstance)
    {
