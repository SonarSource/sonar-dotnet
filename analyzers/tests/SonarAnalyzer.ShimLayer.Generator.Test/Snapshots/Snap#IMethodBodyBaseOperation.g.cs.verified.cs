...
public readonly partial struct IMethodBodyBaseOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IMethodBodyBaseOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IMethodBodyBaseOperationWrapper));
    private readonly IOperation instance;

    private IMethodBodyBaseOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, IOperation> BlockBodyAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "BlockBody");
    public IBlockOperationWrapper BlockBody => IBlockOperationWrapper.From(BlockBodyAccessor(this.instance));
    private static readonly Func<IOperation, IOperation> ExpressionBodyAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "ExpressionBody");
    public IBlockOperationWrapper ExpressionBody => IBlockOperationWrapper.From(ExpressionBodyAccessor(this.instance));
    ...
    public static IMethodBodyBaseOperationWrapper From(IOperation operation)
    {
