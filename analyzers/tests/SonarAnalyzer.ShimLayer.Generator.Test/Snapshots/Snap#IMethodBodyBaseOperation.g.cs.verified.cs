...
public readonly struct IMethodBodyBaseOperationWrapper : IOperationWrapper
{
    ...
    public static IMethodBodyBaseOperationWrapper FromOperation(IOperation instance) =>
        From(instance);
