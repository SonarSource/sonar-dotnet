...
public readonly struct IMethodBodyBaseOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IMethodBodyBaseOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IMethodBodyBaseOperation");
    ...
    private IMethodBodyBaseOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IMethodBodyBaseOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IMethodBodyBaseOperationWrapper left, IMethodBodyBaseOperationWrapper right) =>
    ...
    public static IMethodBodyBaseOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IMethodBodyBaseOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IMethodBodyBaseOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IMethodBodyBaseOperation'");
        }
    }
