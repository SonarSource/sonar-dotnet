...
public readonly partial struct IReturnOperationWrapper : IOperationWrapper
{
    public const string WrappedTypeName = "Microsoft.CodeAnalysis.Operations.IReturnOperation";

    private static readonly Type WrappedType = TypeRegister.LatestType(typeof(IReturnOperationWrapper));
    private readonly IOperation instance;

    private IReturnOperationWrapper(IOperation instance) =>
    ...
    private static readonly Func<IOperation, IOperation> ReturnedValueAccessor = LightupHelpers.CreatePropertyAccessor<IOperation, IOperation>(WrappedType, "ReturnedValue");
    public IOperation ReturnedValue => ReturnedValueAccessor(this.instance);
    ...
    public static IReturnOperationWrapper From(IOperation operation)
    {
