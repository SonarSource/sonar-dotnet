...
public readonly struct IReturnOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IReturnOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IReturnOperation");
    ...
    private static readonly Func<IOperation, IOperation> ReturnedValueAccessor = AccessorFactory.CreateProperty<Func<IOperation, IOperation>>(WrappedType, "ReturnedValue");
    ...
    private IReturnOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IReturnOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IReturnOperationWrapper left, IReturnOperationWrapper right) =>
    ...
    public static IReturnOperationWrapper From(IOperation instance)
    {
        ...
        {
            return new IReturnOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IReturnOperation'");
        }
    }
