...
public readonly struct IStopOperationWrapper : IOperationWrapper, IWrapper, IEquatable<IStopOperationWrapper>
{
    private static readonly Type WrappedType = TypeRegister.LatestType("Microsoft.CodeAnalysis.Operations.IStopOperation");
    ...
    private IStopOperationWrapper(IOperation wrappedInstance) =>
    ...
    public bool Equals(IStopOperationWrapper other) =>
        Equals(wrappedInstance, other.wrappedInstance);

    public static bool operator ==(IStopOperationWrapper left, IStopOperationWrapper right) =>
    ...
    public static IStopOperationWrapper? FromOrDefault(IOperation instance) =>
        IsInstance(instance) ? From(instance) : null;

    public static IStopOperationWrapper From(IOperation instance)
    {
        if (instance is null)
        {
            return default;
        ...
        {
            return new IStopOperationWrapper((IOperation)instance);
        }
        else
        {
            throw new InvalidCastException($"Cannot cast '{instance.GetType().FullName}' to 'Microsoft.CodeAnalysis.Operations.IStopOperation'");
        }
    }
