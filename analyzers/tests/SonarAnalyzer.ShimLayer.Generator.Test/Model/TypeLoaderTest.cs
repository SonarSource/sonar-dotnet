...
public class TypeLoaderTest
{
    ...
    [TestMethod]
    public void LoadLatest_AllTypes() =>
        TypeLoader.LoadLatest().Select(x => x.Type).Should()
    ...
    [TestMethod]
    public void LoadLatest_InheritedMembers() =>
    ...
    [TestMethod]
    public void LoadLatest_ContainsInheritedInterfaces() =>
    ...
    [TestMethod]
    public void LoadLatest_ExplicitInterfaces_Ignored()
    {
