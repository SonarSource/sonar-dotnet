...
{
    private readonly VerifierBuilder roslynCfg = new VerifierBuilder<SonarAnalyzer.Rules.CSharp.InfiniteRecursion>()
    ...
    [TestMethod]
    public void InfiniteRecursion_RoslynCfg_8977_2()
    {
