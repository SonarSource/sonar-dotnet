                ...
                .VerifyUtilityAnalyzer<SymbolReferenceInfo>(symbols =>
                    {
                        ...
                        VerifyReferences(orderedSymbols[0].Reference, 10, 14, 5, 7, 21);     // currentCount
                        VerifyReferences(orderedSymbols[0].Reference, 10, 17, 11, 21, 22);   // IncrementAmount
                        VerifyReferences(orderedSymbols[0].Reference, 10, 19, 9, 52);        // IncrementCount
                        ...
                        VerifyReferences(orderedSymbols[0].Reference, 10, 57, 51);           // AdditionalAttributes
