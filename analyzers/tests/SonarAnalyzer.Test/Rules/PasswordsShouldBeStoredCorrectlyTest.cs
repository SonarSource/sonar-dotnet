...
public class PasswordsShouldBeStoredCorrectlyTest
{
...
#if NET
    private static readonly IEnumerable<MetadataReference> AspNetCoreReferences =
        [
    ...
    [TestMethod]
    public void PasswordsShouldBeStoredCorrectly_CS() =>
        Builder
            .WithOptions(ParseOptionsHelper.FromCSharp8)
            .AddPaths("PasswordsShouldBeStoredCorrectly.cs")
