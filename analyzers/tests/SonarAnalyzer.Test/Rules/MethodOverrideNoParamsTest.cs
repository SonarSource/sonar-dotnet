...
namespace SonarAnalyzer.Test.Rules
{
    ...
    public class MethodOverrideNoParamsTest
    {
        ...
        public void MethodOverrideNoParams_CSharp11() =>
            builder.AddPaths("MethodOverrideNoParams.CSharp11.cs").WithOptions(ParseOptionsHelper.FromCSharp11).VerifyNoIssues();   // Compliant, rule does not apply to interfaces
