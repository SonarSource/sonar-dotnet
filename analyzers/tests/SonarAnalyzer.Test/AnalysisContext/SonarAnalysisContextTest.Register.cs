...
public partial class SonarAnalysisContextTest
{
    ...
    [DataTestMethod]
    [DataRow("", "", false)]
    [DataRow("MainSourceScope", "", true)]
    [DataRow("MainSourceScope", "//<auto-generated />", true)]
    [DataRow("TestSourceScope", "", false)]
    [DataRow("TestSourceScope", "//<auto-generated />", false)]
    public async Task SonarCompilationStartAnalysisContext_RegisterSymbolStartAction_ScopeAndGeneratedCode(string scope, string autogenerated, bool expected)
    {
        ...
        string scope, string autogenerated, params string[] expectedDiagnostics)
    {
        ...
        diagnostics.Select(diagnostic => diagnostic.GetMessage()).Should().BeEquivalentTo(expectedDiagnostics);
