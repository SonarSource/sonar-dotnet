...
public partial class SonarAnalysisContextBaseTest
{
    ...
    [DataTestMethod]
    [DataRow("Foo.cs", new[] { "Foo.cs" }, ProjectType.Product, false)]
    [DataRow("Foo.cs", new[] { "NotFoo.cs" }, ProjectType.Product, true)]
    [DataRow("Foo.cs", new[] { "Foo.cs" }, ProjectType.Test, true)]
    [DataRow("Foo.cs", new[] { "NotFoo.cs" }, ProjectType.Test, true)]
    ...
    [DataTestMethod]
    [DataRow("Foo.cs", new[] { "Foo.cs" }, ProjectType.Product, true)]
    [DataRow("Foo.cs", new[] { "NotFoo.cs" }, ProjectType.Product, true)]
    [DataRow("Foo.cs", new[] { "Foo.cs" }, ProjectType.Test, false)]
    [DataRow("Foo.cs", new[] { "NotFoo.cs" }, ProjectType.Test, true)]
    ...
    [DataTestMethod]
    [DataRow("Foo.cs", new[] { "Foo.cs" }, ProjectType.Product, true)]
    [DataRow("Foo.cs", new[] { "NotFoo.cs" }, ProjectType.Product, false)]
    [DataRow("Foo.cs", new[] { "Foo.cs" }, ProjectType.Test, true)]
    [DataRow("Foo.cs", new[] { "NotFoo.cs" }, ProjectType.Test, true)]
    ...
    [DataRow("Foo.cs", new[] { "NotFoo.cs" }, ProjectType.Product, true)]
    [DataRow("Foo.cs", new[] { "Foo.cs" }, ProjectType.Test, true)]
    [DataRow("Foo.cs", new[] { "NotFoo.cs" }, ProjectType.Test, false)]
    ...
    [DataTestMethod]
    [DataRow("Foo.cs", new[] { "Foo.cs" }, new[] { "Foo.cs" }, false)]
    [DataRow("Foo.cs", new[] { "NotFoo.cs" }, new[] { "Foo.cs" }, false)]
    [DataRow("Foo.cs", new[] { "Foo.cs" }, new[] { "NotFoo.cs" }, true)]
    [DataRow("Foo.cs", new[] { "NotFoo.cs" }, new[] { "NotFoo.cs" }, false)]
