...
//      ^^^^^^^^^^^^^
    ...
    private void CompoundAssignment_NotASet(Dictionary<int, int> dict)
    {
        dict[0] = 0;
        dict[0] += 1; // Compliant
    }

    private void CompoundAssignment_Overwritten(Dictionary<int, int> dict)
    {
        dict[0] += 1; // Secondary
        dict[0] = 2;  // Noncompliant
    }

    private void CompoundAssignment_DoesNotStopTheScan(Dictionary<int, int> dict)
    {
        dict[0] = 1;  // Secondary
    ...
    private void OnlyTheNearest_SetIsReported(Dictionary<int, int> dict)
    {
        dict[0] += 1;
        dict[0] += 2; // Secondary
    ...
    private void UnrelatedAssignmentStopsTheScan(Dictionary<int, int> dict, Dictionary<int, int> other)
    {
        dict[0] = 1;
        other[0] = 1;
