...
public class BasicParameterCases
{
    ...
    //                                         ^^^^^
    {
        _dep.Do();    // Noncompliant [nc1] {{Pass the 'token' to this method to allow cancellation of the operation.}}
        _dep.Do("s"); // Noncompliant [nc2] {{Pass the 'token' to this method to allow cancellation of the operation.}}
    }
...
public class AtThisParameterCases
{
    ...
    {
        _dep.Do(); // Noncompliant {{Pass the '@this' to this method to allow cancellation of the operation.}}
    }

    public void NoncompliantCts(CancellationTokenSource @this) // Secondary
    {
        _dep.Do(); // Noncompliant {{Pass the '@this.Token' to this method to allow cancellation of the operation.}}
    }
...
public class ParameterPrecedenceOverMemberCases
{
    ...
    {
        _dep.Do(); // Noncompliant {{Pass the 'token' to this method to allow cancellation of the operation.}}
    }
}
...
public class ShadowingFieldCases
{
    ...
    {
        _dep.Do(); // Noncompliant [shadow1] {{Pass the 'this._ct' to this method to allow cancellation of the operation.}}
    }

    public void CtParamShadowsCtField(CancellationToken _ct) // Secondary
    {
        _dep.Do(); // Noncompliant {{Pass the '_ct' to this method to allow cancellation of the operation.}}
    }
}
...
public class ShadowingPropertyCases
{
    ...
    {
        _dep.Do(); // Noncompliant [shadow2] {{Pass the 'this.Ct' to this method to allow cancellation of the operation.}}
    }

    public void CtParamShadowsCtProperty(CancellationToken Ct) // Secondary
    {
        _dep.Do(); // Noncompliant {{Pass the 'Ct' to this method to allow cancellation of the operation.}}
    }
}
...
public class RegisterCallbackCases
{
    public void Noncompliant(CancellationToken token) // Secondary
    {
        ...
        token.Register(() => tcs.TrySetCanceled()); // Noncompliant {{Pass the 'token' to this method to allow cancellation of the operation.}}
    }
