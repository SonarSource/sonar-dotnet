...
public static class SonarSyntaxNodeReportingContextExtensions
{
    ...
    {
        // ContainingSymbol.IsGlobalNamespace is needed to avoid the duplicate calls from Roslyn 4.0.0
        public bool IsTopLevelMain => context is { Node: CompilationUnitSyntax { IsTopLevelMain: true }, ContainingSymbol.IsGlobalNamespace: true };
