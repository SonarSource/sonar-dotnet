...
public static class AssignmentExpressionSyntaxExtensions
{
    ...
    {
        /// <summary>
        /// The left and the right side arguments of the assignment, flattened to leaf pairs.
        /// If both sides are tuples, the tuple elements (including nested ones) are paired individually;
        /// otherwise the assignment is returned as a single pair.
        /// <code>
        ...
        /// </code>
        /// </summary>
        public ImmutableArray<AssignmentMapping> FlattenedTupleAssignments
        {
            get
            {
                // (var x, var y) = (1, 2)
        ...
        /// </code>
        /// </summary>
        public ImmutableArray<SyntaxNode> AssignmentTargets
        {
            get
            {
