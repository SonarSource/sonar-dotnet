...
public static class CompilationExtensions
{
    extension(Compilation compilation)
    {
        ...
        public bool ReferencesAll(params KnownAssembly[] assemblies) =>
            Array.TrueForAll(assemblies, x => compilation.References(x));

        public bool References(KnownAssembly assembly) =>
            assembly.IsReferencedBy(compilation);

        public bool IsMemberAvailable<TMemberType>(KnownType type, string memberName, Func<TMemberType, bool> memberCheck = null)
        ...
        public bool ReferencesNetCoreControllers() =>
        ...
        public bool ReferencesNetFrameworkControllers() =>
