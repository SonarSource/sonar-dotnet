...
public abstract class JwtSignedBase<TSyntaxKind, TInvocationSyntax> : SonarDiagnosticAnalyzer<TSyntaxKind>
    ...
    where TInvocationSyntax : SyntaxNode
{
    ...
    protected override string MessageFormat => "Use only strong cipher algorithms when verifying the signature of this JWT.";
