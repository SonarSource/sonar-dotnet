...
public sealed class UsingNonstandardCryptography : UsingNonstandardCryptographyBase<SyntaxKind, TypeDeclarationSyntax>
{
    ...
    protected override INamedTypeSymbol DeclaredSymbol(TypeDeclarationSyntax typeDeclarationSyntax, SemanticModel model) =>
        model.GetDeclaredSymbol(typeDeclarationSyntax);
    ...
    protected override bool DerivesOrImplementsAny(TypeDeclarationSyntax typeDeclarationSyntax) =>
        typeDeclarationSyntax.BaseList is not null && typeDeclarationSyntax.BaseList.Types.Any();
}
