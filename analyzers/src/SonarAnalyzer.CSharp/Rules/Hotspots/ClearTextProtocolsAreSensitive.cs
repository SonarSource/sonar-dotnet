    ...
    public sealed class ClearTextProtocolsAreSensitive : HotspotDiagnosticAnalyzer
    {
        ...
        private static bool IsNamespace(SemanticModel model, SyntaxNode node) =>
            node switch
            {
                ...
                AttributeArgumentSyntax { Parent: AttributeArgumentListSyntax { Parent: AttributeSyntax attribute } } attributeArgument when IsWellknownNamespaceAttribute(model, attribute) => true,
        ...
        private static bool IsWellknownNamespaceAttribute(SemanticModel model, AttributeSyntax attribute) =>
