...
namespace SonarAnalyzer.Helpers
{
    ...
    {
        private static readonly Lazy<CsharpStringValueHelper> Singleton = new(() => new CsharpStringValueHelper());

        public static CsharpStringValueHelper Instance => Singleton.Value;
