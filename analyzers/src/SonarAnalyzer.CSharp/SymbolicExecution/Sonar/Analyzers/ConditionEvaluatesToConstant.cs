        ...
        private sealed class AnalysisContext : ISymbolicExecutionAnalysisContext
        {
            ...
            public IEnumerable<Diagnostic> GetDiagnostics(Compilation compilation)
            {
                ...
                return Enumerable.Empty<Diagnostic>()
                    ...
                    .Union(isNull
                        ...
                        .Except(isNotNull)
                        .Where(x => !IsMuted(x) && !IsInsideCatchOrFinallyBlock(x))
                        .Select(x => S2589.CreateDiagnostic(x.GetLocation(), S2589MessageNull))
                    .Union(isNotNull
                        .Except(isUnknown)
                        .Except(isNull)
                        .Where(x => !IsMuted(x) && !IsInsideCatchOrFinallyBlock(x))
                        .Select(x => S2583.CreateDiagnostic(x.GetLocation(), S2583MessageNotNull))));
            ...
            private static Diagnostic GetNodeDiagnostics(Compilation compilation, SyntaxNode constantNode, bool constantValue)
            {
                ...
                return unreachableLocations.Count > 0
                    ...
                    : S2589.CreateDiagnostic(constantNode.GetLocation(), string.Format(S2589MessageFormatBool, constantText));
            }
