...
namespace SonarAnalyzer.Helpers
{
    ...
    {
        private static readonly ImmutableHashSet<string> GeneratedFileParts = ImmutableHashSet.Create(StringComparer.OrdinalIgnoreCase,
            ".g.",
            ".generated.",
            ".designer.",
            "_generated.",
        ...
        private static readonly ImmutableHashSet<string> AutoGeneratedCommentParts = ImmutableHashSet.Create(StringComparer.OrdinalIgnoreCase,
            "<AUTO-GENERATED",
            "<AUTOGENERATED",
            "GENERATED BY");
        ...
        private bool HasAutoGeneratedComment(SyntaxNode root)
        {
            ...
            return firstToken.LeadingTrivia
                ...
                .Any(trivia => AutoGeneratedCommentParts.Contains(trivia.ToString()));
        }
        ...
        private static bool HasGeneratedFileName(SyntaxTree tree) =>
            GeneratedFileParts.Contains(Path.GetFileName(tree.FilePath));
    }
}
