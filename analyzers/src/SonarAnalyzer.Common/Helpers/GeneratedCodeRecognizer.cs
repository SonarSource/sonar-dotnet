...
namespace SonarAnalyzer.Helpers
{
    ...
    {
        private static readonly ImmutableList<string> GeneratedFileParts = ImmutableList.Create(
            ".g.",
            ".generated.",
            ".designer.",
            "_generated.",
        ...
        private static readonly ImmutableList<string> AutoGeneratedCommentParts = ImmutableList.Create(
            "<auto-generated",
            "<autogenerated",
            "generated by");

        private static readonly ImmutableList<string> GeneratedCodeAttributes = ImmutableList.Create(
            "DebuggerNonUserCode",
        ...
        private bool HasAutoGeneratedComment(SyntaxNode root)
        {
            ...
            return firstToken.LeadingTrivia
                ...
                .Any(trivia => AutoGeneratedCommentParts.Exists(part => trivia.ToString().IndexOf(part, StringComparison.OrdinalIgnoreCase) >= 0));
        }
        ...
        private bool HasGeneratedCodeAttribute(SyntaxNode root)
        {
            ...
            return attributeNames.Any(attributeName =>
                GeneratedCodeAttributes.Exists(generatedCodeAttribute =>
