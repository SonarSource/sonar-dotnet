...
using RoslynCodeFixContext = Microsoft.CodeAnalysis.CodeFixes.CodeFixContext;

namespace SonarAnalyzer.CodeFixContext
{
    public readonly struct SonarCodeFixContext
    {
        private readonly RoslynCodeFixContext context;
        ...
        public SonarCodeFixContext(RoslynCodeFixContext context) =>
