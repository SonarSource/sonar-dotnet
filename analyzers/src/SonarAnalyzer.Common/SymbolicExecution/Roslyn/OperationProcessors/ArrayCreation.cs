...
internal sealed class ArrayCreation : SimpleProcessor<IArrayCreationOperationWrapper>
{
    protected override IArrayCreationOperationWrapper Convert(IOperation operation) =>
