...
namespace SonarAnalyzer.Rules
{
    public abstract class DisablingRequestValidationBase : HotspotDiagnosticAnalyzer
    {
        ...
        private void CheckController(SonarSymbolAnalysisContext c)
        {
            ...
            {
                c.ReportIssue(Language.GeneratedCodeRecognizer, Diagnostic.Create(rule, attributeWithFalseParameter.ApplicationSyntaxReference.GetSyntax().GetLocation()));
            }
        }
