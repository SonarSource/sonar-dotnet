...
namespace SonarAnalyzer.Rules
{
        ...
        where TArgumentSyntax : SyntaxNode
    {
        ...
        protected abstract SyntaxNode GetExpression(TArgumentSyntax argument);
        ...
        private bool IsInsecureBaseAlgorithmCreationFactoryCall(IMethodSymbol methodSymbol, TInvocationExpressionSyntax invocationExpression)
        {
            ...
            return FactoryParameterNames.Any(alg => alg.Equals(Language.Syntax.LiteralText(GetExpression(Arguments(argumentList).First())), StringComparison.Ordinal));
        }
